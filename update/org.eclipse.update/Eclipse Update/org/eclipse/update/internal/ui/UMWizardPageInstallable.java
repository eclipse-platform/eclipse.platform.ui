...
/*
 * Set checked if:
 *   Component is available to install
 *     AND Component is not installed
 *     OR  Component is currently installed
 *       AND Available version is newer than current version
 *
...
/**
 * Set unchecked.
 * If this is a component entry and the entry is optional, deselect it.
 */
