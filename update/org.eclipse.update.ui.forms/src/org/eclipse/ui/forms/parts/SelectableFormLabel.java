...
/**
 * This custom control is capable of accepting keyboard
 * focus and be activated from the keyboard (pressing
 * 'Enter' while the focus is in the control). Focus
 * indication is rendered using platform-specific way.
 */
