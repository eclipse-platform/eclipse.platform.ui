...
*/
     ...
     Hyperlink link = toolkit.createHyperlink(c, "Sample hyperlink", SWT.WRAP);
     ...
     ExpandableComposite exp = toolkit.createExpandableComposite(c, ExpandableComposite.TWISTIE);
     ...
     exp.setTitle("Expandable Section");
      td = new TableData();
     //td.colspan = 2;
     td.align = TableData.FILL;
