...
public class UpdatesForm extends UpdateWebForm {
	...
	private static final String KEY_MY_COMPUTER_CHECK =
		"UpdatesPage.options.myComputerCheck";
	private static final String KEY_MY_COMPUTER_TITLE =
		"UpdatesPage.options.myComputerSettings.title";
	private static final String KEY_MY_COMPUTER_MORE =
		"UpdatesPage.options.myComputerSettings";
	private static final String KEY_FULL_MODE_CHECK =
		"UpdatesPage.options.fullModeCheck";
	private static final String UPDATES_IMAGE_ID = "updates";
	private static final String SETTINGS_SECTION = "UpdatesForm";
	...
	protected void createContents(Composite parent) {
		...
		descLabel.registerTextObject(
			UPDATES_IMAGE_ID,
			UpdateUIPluginImages.get(UpdateUIPluginImages.IMG_UPDATES_OBJ));
