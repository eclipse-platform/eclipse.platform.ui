...
public class MoreInfoGenerator {
	...
	public String createURL(PendingChange job) {
		try {
	...
	private void createMoreInfoContent(PendingChange job, PrintWriter out) {
	...
	private void createProfileTable(PendingChange job, PrintWriter out) {
		IFeature feature =job.getFeature();
	...
	private void createEnvironmentTable(PendingChange job, PrintWriter out) {
		IFeature feature = job.getFeature();
		out.println("<table border=\"0\" width=\"100%\">");
		out.println("<tr>");
