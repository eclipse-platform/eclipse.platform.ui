...
//	public final static String EDITOR_EVALUTE_TEMPORARY_PROBLEMS= "handleTemporaryProblems"; //$NON-NLS-1$
	...
	public static void initializeDefaultValues(IPreferenceStore store) {
		...
		store.setDefault(TextEditorPreferenceConstants.EDITOR_PROBLEM_INDICATION, true);
		PreferenceConverter.setDefault(store, TextEditorPreferenceConstants.EDITOR_PROBLEM_INDICATION_COLOR, new RGB(255, 0 , 128));
		store.setDefault(TextEditorPreferenceConstants.EDITOR_ERROR_INDICATION_IN_OVERVIEW_RULER, true);

		store.setDefault(TextEditorPreferenceConstants.EDITOR_WARNING_INDICATION, true);
		PreferenceConverter.setDefault(store, TextEditorPreferenceConstants.EDITOR_WARNING_INDICATION_COLOR, new RGB(244, 200 , 45));
		store.setDefault(TextEditorPreferenceConstants.EDITOR_WARNING_INDICATION_IN_OVERVIEW_RULER, true);

		store.setDefault(TextEditorPreferenceConstants.EDITOR_INFO_INDICATION, true);
		PreferenceConverter.setDefault(store, TextEditorPreferenceConstants.EDITOR_INFO_INDICATION_COLOR, new RGB(244, 200 , 45));
		store.setDefault(TextEditorPreferenceConstants.EDITOR_INFO_INDICATION_IN_OVERVIEW_RULER, true);

		store.setDefault(TextEditorPreferenceConstants.EDITOR_TASK_INDICATION, false);
		PreferenceConverter.setDefault(store, TextEditorPreferenceConstants.EDITOR_TASK_INDICATION_COLOR, new RGB(0, 128, 255));
		store.setDefault(TextEditorPreferenceConstants.EDITOR_TASK_INDICATION_IN_OVERVIEW_RULER, false);

		store.setDefault(TextEditorPreferenceConstants.EDITOR_BOOKMARK_INDICATION, false);
		PreferenceConverter.setDefault(store, TextEditorPreferenceConstants.EDITOR_BOOKMARK_INDICATION_COLOR, new RGB(34, 164, 99));
		store.setDefault(TextEditorPreferenceConstants.EDITOR_BOOKMARK_INDICATION_IN_OVERVIEW_RULER, false);

		store.setDefault(TextEditorPreferenceConstants.EDITOR_SEARCH_RESULT_INDICATION, false);
		PreferenceConverter.setDefault(store, TextEditorPreferenceConstants.EDITOR_SEARCH_RESULT_INDICATION_COLOR, new RGB(192, 192, 192));
		store.setDefault(TextEditorPreferenceConstants.EDITOR_SEARCH_RESULT_INDICATION_IN_OVERVIEW_RULER, false);
...
//		store.setDefault(TextEditorPreferenceConstants.EDITOR_EVALUTE_TEMPORARY_PROBLEMS, true);
