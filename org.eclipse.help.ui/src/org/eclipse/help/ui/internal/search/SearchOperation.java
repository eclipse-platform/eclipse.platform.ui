...
public class SearchOperation extends WorkspaceModifyOperation {
	...
	protected void execute(IProgressMonitor monitor)
		...
		try {
			...
			if (HelpSystem.getSearchManager().isIndexingNeeded(queryData.getLocale()))
				HelpSystem.getSearchManager().updateIndex(monitor, queryData.getLocale());
			...
			Logger.logError(WorkbenchResources.getString("ES16"), e);
		}
		monitor.done();
	}
