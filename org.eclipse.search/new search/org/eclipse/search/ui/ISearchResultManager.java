...
public interface ISearchResultManager {
	...
	/**
	 * Removes the given search result from this manager.
	 * Does nothing if the search result is not found
	 * @param search
	 */
	void removeSearchResult(ISearchResult searchResult);
	/**
	 * Adds the given search result to the search manager
	 * Does nothing if the search result is already present.
	 * @param searchResult
	 */
	void addSearchResult(ISearchResult searchResult);
	/**
	 * Adds the give search result listener.
	 * @param l The ISearchResultListener to be added.
	 */
	public void addSearchResultListener(ISearchResultListener l);
	/**
	 * Removes the give ISearchResultListener. Does nothing 
	 * if the listener is not present.
	 * @param l The listener to be removed.
	 */
	public void removeSearchResultListener(ISearchResultListener l);
	/**
	 * Removes all ISearchResults from this search manager.
	 */
	void removeAll();
}
