...
public interface IAppServer
{
	 ...
	 * @param webApp the name of the web application (context name)
	 ...
	 */
	boolean add(String webApp, String plugin, String path);
	...
	/**
	 * Sets the host and port for the app server. Must be called before start().
