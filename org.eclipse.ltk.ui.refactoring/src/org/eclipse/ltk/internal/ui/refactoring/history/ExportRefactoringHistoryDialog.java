...
import org.eclipse.ltk.internal.core.refactoring.history.RefactoringSessionToolFactory;
...
public final class ExportRefactoringHistoryDialog extends RefactoringHistoryDialog {
	...
	protected final void handleExport(final String caption, final RefactoringDescriptorHandle[] handles) {
		...
		if (path != null) {
			try {
				final IRefactoringSessionTransformer transformer= RefactoringSessionToolFactory.createDefaultTransformer();
				try {
