...
{
    private static final String WARNING = "WARNING: Autogenerated file. " + StringUtil.NEWLINE +//$NON-NLS-1$
                                          "Any modifications will be overwritten." + StringUtil.NEWLINE + //$NON-NLS-1$
                                          "             Please edit build-user.xml instead" + StringUtil.NEWLINE; //$NON-NLS-1$
    
    private static final String USER_TARGET = "<target name=\"help\">" + StringUtil.NEWLINE + //$NON-NLS-1$
                                              "    <echo message=\"Please run: $ ant -v -projecthelp\"/>" + StringUtil.NEWLINE + //$NON-NLS-1$
                                              "</target>"; //$NON-NLS-1$
    ...
    public BuildFileCreator(IJavaProject project) throws ParserConfigurationException
    {
        ...
        this.projectRoot = EclipseUtil.getProjectRoot(project);
    ...
    public void createBuildFiles(IJavaProject javaProject) throws JavaModelException, ParserConfigurationException,
        TransformerConfigurationException, TransformerException, IOException, CoreException
    {
        Set allSubProjects = EclipseUtil.getClasspathProjectsRecursive(javaProject);
        ...
        for (Iterator iter = allSubProjects.iterator(); iter.hasNext();)
        {
            ...
            this.projectRoot = EclipseUtil.getProjectRoot(mainProject);
            ...
            Set subProjects = EclipseUtil.getClasspathProjects(mainProject);
            ...
            String xml = XmlUtil.addEntity(doc, "buildfile", "./build-user.xml"); //$NON-NLS-1$ //$NON-NLS-2$
    ...
    public Element createClasspath(String pathId, IJavaProject project, String newProjectRoot, Map variable2valueMap) throws JavaModelException
    {
        ...
        for (Iterator iterator = CollectionUtil.removeDuplicates(classpath.rawClassPathEntries).iterator(); iterator.hasNext();)
        {
    ...
    public void addSubClasspaths(Map variable2valueMap, Set subProjects) throws JavaModelException
    {
        for (Iterator iterator = subProjects.iterator(); iterator.hasNext();)
        {
            ...
            variable2valueMap.put(location, EclipseUtil.getProjectRoot(subProject));
     ...
     */
    private static String addVariable(Map variable2valueMap, String variable)
    {
        if (variable == null || variable.equals("")) //$NON-NLS-1$
        {
            return null;
        }
        String value;
        ...
        {
            variable2valueMap.put(StringUtil.removePrefixAndSuffix(variable, "${", "}"), value); //$NON-NLS-1$ //$NON-NLS-2$
        }
        return value;
    }
...
//            }
    ...
    public void addJUnit(Map variable2valueMap, ILaunchConfiguration conf) throws CoreException
    {
        ...
        else
        {
            ...
            IType[] types = EclipseUtil.findTestsInContainer(container);
