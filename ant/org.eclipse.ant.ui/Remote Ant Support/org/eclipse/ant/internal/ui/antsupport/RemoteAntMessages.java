...
public class RemoteAntMessages extends NLS {
	...
	public static String InternalAntRunner_Could_not_load_property_file__0____1__4;
	...
	public static String InternalAntRunner_161;
	public static String InternalAntRunner_162;

	public static String RemoteAntBuildLogger_1;
	public static String RemoteAntBuildLogger_Total_time;
	public static String RemoteAntBuildLogger__minutes_2;
	public static String RemoteAntBuildLogger__minute_3;
	public static String RemoteAntBuildLogger__seconds_4;
	public static String RemoteAntBuildLogger__second_5;
	public static String RemoteAntBuildLogger__milliseconds_6;

	public static String SWTInputHandler_0;
	public static String SWTInputHandler_1;
	public static String SWTInputHandler_2;
	public static String SWTInputHandler_3;
	public static String SWTInputHandler_4;
	public static String SWTInputHandler_5;

	static {
		// load message values from bundle file
		NLS.initializeMessages(BUNDLE_NAME, RemoteAntMessages.class);
	}
}