...
public class ArchiveSourceContainer extends AbstractSourceContainer {
	 ...
	 */
	public ArchiveSourceContainer(String archivePath, boolean detectRootPath) {
	...
	private void detectRoot(ZipFile file, String name) throws CoreException {
		synchronized (file) {
			...
			try {
				...
				abort(MessageFormat.format(SourceLookupMessages.getString("ArchiveSourceContainer.1"), new String[] {getName()}), e); //$NON-NLS-1$
			}
		}		
	}
