...
public abstract class ModifyWatchpointAction implements IObjectActionDelegate, IActionDelegate2 {
    ...
    public void run(IAction action) {
        try {
            ...
            DebugUIPlugin.errorDialog(DebugUIPlugin.getShell(), ActionMessages.getString("ModifyWatchpointAction.0"), ActionMessages.getString("ModifyWatchpointAction.1"), e.getStatus()); //$NON-NLS-1$ //$NON-NLS-2$
        }
