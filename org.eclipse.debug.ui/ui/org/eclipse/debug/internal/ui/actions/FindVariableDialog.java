...
public class FindVariableDialog extends Dialog {
    ...
    private class FindVariableModelPresentation implements IDebugModelPresentation {
        ...
        public String getText(Object element) {
            ...
            return ActionMessages.getString("FindVariableDialog.0"); //$NON-NLS-1$
        }
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        label.setLayoutData(new GridData(GridData.FILL_HORIZONTAL));
        label.setFont(parent.getFont());
        label.setText(ActionMessages.getString("FindVariableDialog.2")); //$NON-NLS-1$
    ...
    protected void configureShell(Shell newShell) {
        newShell.setText(ActionMessages.getString("FindVariableDialog.3")); //$NON-NLS-1$
