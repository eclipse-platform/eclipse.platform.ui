...
public class EnableDisableBreakpointAction extends SelectionProviderAction implements IUpdate {
	...
	public EnableDisableBreakpointAction(ISelectionProvider selectionProvider) {
		super(selectionProvider, ActionMessages.getString("EnableDisableBreakpointAction.&Enable/Disable_1")); //$NON-NLS-1$
	...
	public void selectionChanged(IStructuredSelection sel) {
		...
		if (!enum.hasNext()) {
			...
			try {
				if (bp.isEnabled()) {
					setText(ActionMessages.getString("EnableDisableBreakpointAction.&Disable_5")); //$NON-NLS-1$
				} else {
					setText(ActionMessages.getString("EnableDisableBreakpointAction.&Enable_6")); //$NON-NLS-1$
				}
			...
			// multi- selection
			setText(ActionMessages.getString("EnableDisableBreakpointAction.&Enable/Disable_1")); //$NON-NLS-1$
		}
		setEnabled(true);
	}
