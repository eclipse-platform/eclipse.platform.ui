...
public class SetPaddedStringDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		textLabel.setText(DebugUIMessages.getString("SetPaddedStringDialog.1")); //$NON-NLS-1$
	...
	protected void okPressed() {
		...
		{
			MemoryViewUtil.openError(DebugUIMessages.getString("SetPaddedStringDialog.3"), DebugUIMessages.getString("SetPaddedStringDialog.4"), null); //$NON-NLS-1$ //$NON-NLS-2$
			return;
		}
