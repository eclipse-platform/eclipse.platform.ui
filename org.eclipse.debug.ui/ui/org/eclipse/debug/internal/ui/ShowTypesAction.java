...
public class ShowTypesAction extends Action {
	...
	public ShowTypesAction(StructuredViewer viewer) {
		...
		setViewer(viewer);
		setToolTipText(DebugUIMessages.getString("ShowTypesAction.Show_&Type_Names_1")); //$NON-NLS-1$
	...
	private void valueChanged(boolean on) {
		...
		setToolTipText(on ? DebugUIMessages.getString("ShowTypesAction.Hide_&Type_Names_3") : DebugUIMessages.getString("ShowTypesAction.Show_&Type_Names_1")); //$NON-NLS-2$ //$NON-NLS-1$
	}
