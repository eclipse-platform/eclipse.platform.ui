...
public class LaunchWizardNode implements IWizardNode {
	...
	public IWizard getWizard() {
		...
		try {
			...
			DebugUIPlugin.errorDialog(fParentWizardPage.getControl().getShell(), DebugUIMessages.getString("LaunchWizardNode.Problem_Opening_Wizard_4"),DebugUIMessages.getString("LaunchWizardNode.The_selected_wizard_could_not_be_started._5") , e); //$NON-NLS-2$ //$NON-NLS-1$
			return null;
		}
