 ...
 * 
 * TODO: Copied from JFace. Should attempt to reduce code duplication in future
 */
/* package */abstract class TreeEditorImpl {
    ...
    abstract Rectangle getBounds(Item item, int columnIndex);
     ...
     */
    private void saveEditorValue(CellEditor editor, Item item) {
        if (cellModifier != null) {
            ...
            cellModifier.modify(item.getData(), property, editor.getValue());
        }
    }
