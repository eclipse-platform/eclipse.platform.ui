...
/**
 * Default content provider for the debug view. Clients can override
 * the hierarchy displayed in the debug view for a debug model by
 * contributing a content provider via the <code>debugViewContentProviders</code>
 * extension point.
 * <p>
 * Clients contributing a debug view content provider may subclass
 * this class.
 * </p>
 * 
 * @since 3.1
 */
public class DefaultDebugViewContentProvider implements ITreeContentProvider {
