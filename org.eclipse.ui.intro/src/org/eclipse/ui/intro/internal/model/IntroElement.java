 ...
 * <br>Clients are not expected to implement/subclass this class, or any of
 * its subclasses.
 * </p>
 */
public abstract class IntroElement {
	 ...
	 */
	public static final int ABSTRACT_CONTAINER =
		ABSTRACT_PAGE | DIV | MODEL_ROOT;
	 ...
	 */
	public static final int BASE_ELEMENT =
		ABSTRACT_CONTAINER
			| ABSTRACT_TEXT
			| IMAGE
			| INCLUDE
	...
	/**
	 * Returns the parent. For the model root, it retruns null. For the
	 * introPart presentation it returns a model root. For Pages, it returns an
	 * intro model root. For all other elements, it retruns a subclass of
	 * abstract container, except for divs that are children of configs (shared
	 * divs), it returns a model root.
	 * 
	 ...
	 * the page itself. For all other element, returns the holding page, except
	...
	public AbstractIntroPage getParentPage() {
		...
		while (parent != null && !parent.isOfType(IntroElement.ABSTRACT_PAGE))
	 ...
	 * among the specified element types. <br>An example of an element mask is
	 * as follows:
	 * <p>
	 * <code>
	 * int elementMask = IntroElement.DIV | IntroElement.LINK;
