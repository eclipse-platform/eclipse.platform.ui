...
public class RadioGroup {
	...
	/**
	 * (Non-API) Interface IRadioButton. A duck interface that is used internally by
	 * RadioGroup and by RadioGroup's unit tests.
	 */
	...
	/**
	 * Constructs an instance of this widget given an array of Button objects to
	 * wrap. The Button objects must have been created with the SWT.RADIO style bit
	 * set, and they must all be in the same Composite.
	 *
	 * @param radioButtons Object[] an array of radio buttons to wrap.
	 * @param values       Object[] an array of objects corresponding to the value
	 ...
	 * equals() the object specified by newSelection. If !newSelection.equals() any
	 * model object managed by this radio group, deselects all radio buttons.
	 *
	 * @param newSelection A model object corresponding to one of the model objects
...
//            selectedButton.notifyListeners(SWT.Selection, null);
	 ...
	 * the receiver's selection is about to change, by sending it one of the
	 * messages defined in the <code>VetoableSelectionListener</code> interface.
	 * <p>
	 ...
	 * when the receiver's selection is about to change.
	 *
	 ...
	 *                                     </ul>
	 *
	 *                                     FIXME: tck - this should be renamed to
	 *                                     getItemText()
	 */
