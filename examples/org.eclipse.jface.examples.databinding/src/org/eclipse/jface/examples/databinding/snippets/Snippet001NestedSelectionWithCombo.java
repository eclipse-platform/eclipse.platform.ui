...
public class Snippet001NestedSelectionWithCombo {
    ...
    static class View {
        ...
        public Shell createShell() {
            ...
            IObservableValue selectedPerson = new SelectionObservableValue(peopleListViewer);
            dbc.bindValue(SWTObservables.getText(name, SWT.Modify),
                    MasterDetailObservables.getDetailValue(selectedPerson, getDetailFactory("name"), String.class),
                    null);
            ...
            IObservableValue citySelection = new SelectionObservableValue(cityViewer);
            dbc.bindValue(citySelection, MasterDetailObservables.getDetailValue(selectedPerson,
