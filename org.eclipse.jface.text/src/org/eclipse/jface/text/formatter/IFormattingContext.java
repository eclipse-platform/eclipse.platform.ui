...
public interface IFormattingContext {
	 ...
	 * <p>
	 * Must be called after the formatting context
	 * has been used in a formatting process. 
	 */
	void dispose();

	/**
	 * Returns the preference keys used for the retrieval
	 ...
	 * @return <code>true</code> iff this key is for a boolean preference, <code>false</code> otherwise.
	 */
	 ...
	 *
	 *@param key The preference key to query its type
	 * @return <code>true</code> iff this key is for a double preference, <code>false</code> otherwise.
	 */
	 ...
	 *
	 *@param key The preference key to query its type
	 * @return <code>true</code> iff this key is for a float preference, <code>false</code> otherwise.
	 */
	 ...
	 *
	 *@param key The preference key to query its type
	 * @return <code>true</code> iff this key is for an integer preference, <code>false</code> otherwise.
	 */
	 ...
	 *
	 *@param key The preference key to query its type
	 * @return <code>true</code> iff this key is for a long preference, <code>false</code> otherwise.
	 */
	 ...
	 *
	 *@param key The preference key to query its type
	 * @return <code>true</code> iff this key is for a string preference, <code>false</code> otherwise.
	 */
	 ...
	 * be used in the preference store. Otherwise the preferences are overwritten.
	 * </p>
	 * 
	 ...
	 * <p>
	 * Note that the preference keys returned by {@link getPreferenceKeys()} must not
	 * be used in the map. Otherwise the preferences are overwritten.
	 * </p>
	 * 
	 * @param store Preference store to retrieve the preferences from
	 * @param map Map to store the preferences in
	 * @param useDefault <code>true</code> iff the default preferences should be used, <code>false</code> otherwise
	 */
