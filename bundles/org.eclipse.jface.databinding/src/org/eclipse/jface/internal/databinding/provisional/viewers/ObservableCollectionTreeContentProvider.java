...
public abstract class ObservableCollectionTreeContentProvider implements
	...
	private IParentProvider parentProvider;
	...
	protected ObservableCollectionTreeContentProvider(
			IParentProvider parentProvider, IObservableFactory collectionFactory) {
	...
	public Object getParent(Object element) {
		...
		if (parentProvider != null)
			parent = parentProvider.getParent(element);
		if (parent == null) {
	...
	protected final class TreeNode {
		...
		void removeParent(Object oldParent) {
			if (parentSet != null)
