 ...
 * nodes for which ITreeProvider.createChildSet returns null).
 */
public class LeafNodesSet extends AbstractObservableSet {
     ...
     * 
     * @param tree tree whose leaf nodes will be computed
     */
    public LeafNodesSet(ITreeProvider tree) {
        this.tree = tree;
    }
     ...
     * 
     * @param initialInput root of the tree
     * @param tree tree whose leaf nodes will be computed
     */
    public LeafNodesSet(Object initialInput, ITreeProvider tree) {
        this.tree = tree;
        setInput(initialInput);
    }
    
    private void processDiff(SetDiff diff) {
     ...
     * Sets the root of the tree to the given element.
     * 
     * @param input new root of the tree
     */
