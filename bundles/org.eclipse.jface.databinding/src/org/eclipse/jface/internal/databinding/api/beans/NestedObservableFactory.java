...
public class NestedObservableFactory implements IObservableFactory {
	public IObservable createObservable(IDataBindingContext bindingContext,Object description) {
		if (description instanceof NestedProperty) {
			return createNestedObservable((NestedProperty)description, bindingContext);
...
//					return new NestedObservableCollection(
//							bindingContext, observableValue,
//							propertyID, propertyType);
//				}
				return new NestedObservableValue(
						bindingContext, observableValue,
						propertyID, propertyType);
			}
...
//				return new NestedObservableCellProvider(bindingContext,(IObservableValue) master,tableModelDescription);
//			}
//		}
		return null;
	}
	
	private IObservable createNestedObservable(NestedProperty nestedProperty, IDataBindingContext bindingContext) {
		...
		if (nestedProperty.getPrototypeClass() != null) {
			...
			while (tokenizer.hasMoreElements()) {
				...
				lastChildObservable = bindingContext.createObservable(new Property(targetObject,
