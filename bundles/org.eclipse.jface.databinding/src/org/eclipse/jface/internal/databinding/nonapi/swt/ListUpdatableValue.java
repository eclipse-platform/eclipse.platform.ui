...
import org.eclipse.jface.databinding.ObservableValue;
 ...
 * 
 */
public class ListObservableValue extends ObservableValue {
	 ...
	 * @param attribute
	 */
	public ListObservableValue(List list, String attribute) {
		this.list = list;
