 ...
 * 
 */
final public class CopyOfBeanUpdatableFactory implements IUpdatableFactory {
				...
				for (int i = 0; i < propertyDescriptors.length; i++) {
					...
					if (descriptor.getName().equals(
						...
						if (descriptor.getPropertyType().isArray() || Collection.class.isAssignableFrom(descriptor.getPropertyType())){
							...
							return new CopyOfJavaBeanUpdatableCollection(description,
									bindingContext, object, descriptor, elementType);
						}						
