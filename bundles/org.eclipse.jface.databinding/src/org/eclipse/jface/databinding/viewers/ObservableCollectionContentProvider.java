 ...
 * @since 1.2
 */
abstract class ObservableCollectionContentProvider implements
	 ...
	 *            the input to check
	 */
	abstract void checkInput(Object input);
	 ...
	 */
	abstract void addCollectionChangeListener(IObservableCollection collection);
	 ...
	 */
	abstract void removeCollectionChangeListener(
	 ...
	 */
	final boolean isViewerDisposed() {
