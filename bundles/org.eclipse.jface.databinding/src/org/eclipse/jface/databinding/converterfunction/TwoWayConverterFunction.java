 ...
 * @since 3.2
 */
public class TwoWayConverterFunction {
	 ...
	 */
	public TwoWayConverterFunction(Class targetType, Class modelType) {
	 ...
	 * @param modelToTarget
	 */
	public TwoWayConverterFunction(IConversionFunction targetToModel, IConversionFunction modelToTarget) {
