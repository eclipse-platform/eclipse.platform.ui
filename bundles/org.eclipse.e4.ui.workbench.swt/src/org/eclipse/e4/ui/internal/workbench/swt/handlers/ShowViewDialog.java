...
/**
 * The Show View dialog. The real one is in org.eclipse.ui.internal.dialogs.ShowViewDialog;
 * this is a temporary placeholder as the original dialog brings lots of extra things in.
 */
public class ShowViewDialog extends Dialog {
	...
	protected void okPressed() {
        ...
        ArrayList<MPartDescriptor> tmp = new ArrayList<MPartDescriptor>(selection.size());
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        tableViewer = new TableViewer(composite, SWT.H_SCROLL | SWT.V_SCROLL | SWT.BORDER | SWT.MULTI);
