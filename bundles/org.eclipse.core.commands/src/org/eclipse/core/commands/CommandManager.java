...
public final class CommandManager extends HandleObjectManager implements
	 ...
	 * and <code>%</code> are escaped by prepending a <code>%</code>
	 * character.
	 * 
	 * @param escapedText
	...
	public final ParameterizedCommand deserialize(
		...
		if (lparenPosition == -1) {
			...
			if (!serializedParameterizedCommand.endsWith(")")) { //$NON-NLS-1$
				throw new SerializationException(
	 ...
	 * but disregards characters prefixed with the <code>%</code> escape
