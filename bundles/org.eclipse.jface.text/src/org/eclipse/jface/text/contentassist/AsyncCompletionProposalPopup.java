...
class AsyncCompletionProposalPopup extends CompletionProposalPopup {
	...
	private static final class ComputingProposal implements ICompletionProposal, ICompletionProposalExtension {
		...
		public String getAdditionalProposalInfo() {
			 return NLS.bind(JFaceTextMessages.getString("AsyncCompletionProposalPopup.computingDetails"), Integer.valueOf(fSize), Integer.valueOf(fSize - fRemaining), Integer.valueOf(fRemaining));
		}
