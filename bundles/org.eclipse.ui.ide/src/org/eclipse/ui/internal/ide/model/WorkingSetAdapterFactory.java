...
public class WorkingSetAdapterFactory implements IAdapterFactory {
    ...
    /*
     * Adapter for converting a working set to a resource mapping for
     * use by object contributions.
     */
    class ContributorResourceAdapter implements IContributorResourceAdapter2 {
        ...
        public ResourceMapping getAdaptedResourceMapping(IAdaptable adaptable) {
            if (adaptable instanceof IWorkingSet) {
                ...
                if (!result.isEmpty())
                    return new CompositeResourceMapping(adaptable, (ResourceMapping[]) result.toArray(new ResourceMapping[result.size()]));
            }
            return null;
        }
    ...
    public Object getAdapter(Object adaptableObject, Class adapterType) {
        if (adaptableObject instanceof IWorkingSet) {
            ...
            if (adapterType == ResourceMapping.class) {
                ...
                if (!result.isEmpty())
                    return new CompositeResourceMapping(adaptableObject, (ResourceMapping[]) result.toArray(new ResourceMapping[result.size()]));
            }
        }
        return null;
    }
    ...
    /* package */ ResourceMapping getResourceMapping(Object o) { 
    ...
    /* package */ ResourceMapping getContributedResourceMapping(IAdaptable element) { 
    ...
    /* package */  Object internalGetAdapter(Object o, Class adapter) {
