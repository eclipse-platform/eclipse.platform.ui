 ...
 */
/*package*/class ZipFileResourceExportOperation implements
     ...
     *  @param filename java.lang.String
     */
    public ZipFileResourceExportOperation(IResource res, List resources,
            String filename) {
        this(res, filename);
        resourcesToExport = resources;
    }
    ...
    protected void exportResource(IResource resource)
        ...
        if (resource.getType() == IResource.FILE) {
            String destinationName = resource.getFullPath()
                    .removeFirstSegments(leadupStartDepth).toString();
            ...
            try {
                ...
                addError(
                        IDEWorkbenchMessages
                                .format(
                                        "ZipExport.errorOnResource", new Object[] { resource.getFullPath() }), e); //$NON-NLS-1$
    ...
    protected void initialize() throws IOException {
        exporter = new ZipFileResourceExporter(destinationFilename,
                useCompression, generateManifestFile);
    ...
    public void run(IProgressMonitor monitor) throws InvocationTargetException,
        ...
        try {
            ...
            throw new InvocationTargetException(e, IDEWorkbenchMessages
                    .getString("ZipExport.unableToOpen") + e.getMessage()); //$NON-NLS-1$
        }
        ...
        try {
            ...
            monitor.beginTask(IDEWorkbenchMessages
                    .getString("ZipExport.progress"), totalWork); //$NON-NLS-1$
            if (resourcesToExport == null) {
            ...
            try {
                ...
                throw new InvocationTargetException(e, IDEWorkbenchMessages
                        .getString("ZipExport.unableToClose") + e.getMessage()); //$NON-NLS-1$
            }
        } finally {
            monitor.done();
        }
