...
public class WizardFileSystemImportPage1 extends WizardImportPage
    ...
    private static final String TYPE_DELIMITER = DataTransferMessages
            .getString("DataTransfer.typeDelimiter"); //$NON-NLS-1$
     ...
     */
    protected WizardFileSystemImportPage1(String name, IWorkbench aWorkbench,
     ...
     *	Creates an instance of this class
     */
    public WizardFileSystemImportPage1(IWorkbench aWorkbench,
            IStructuredSelection selection) {
    ...
    protected void createOptionsGroup(Composite parent) {
        ...
        createContainerStructureCheckbox.setText(DataTransferMessages
    ...
    protected void createSourceGroup(Composite parent) {
        ...
        sourceTypesGroup.setLayoutData(new GridData(
                GridData.HORIZONTAL_ALIGN_FILL | GridData.GRAB_HORIZONTAL));

        // all types radio
        importAllResourcesRadio = new Button(sourceTypesGroup, SWT.RADIO);
        importAllResourcesRadio.setText(DataTransferMessages
                .getString("DataTransfer.allTypes")); //$NON-NLS-1$
        ...
        importTypedResourcesRadio.setText(DataTransferMessages
                .getString("FileImport.filesofType")); //$NON-NLS-1$
        ...
        typesToImportEditButton.setText(DataTransferMessages
                .getString("FileImport.edit")); //$NON-NLS-1$
        ...
        fileDetailsGroup.setLayoutData(new GridData(
                GridData.HORIZONTAL_ALIGN_FILL | GridData.GRAB_HORIZONTAL));

        // details button
        detailsButton = new Button(fileDetailsGroup, SWT.PUSH);
        detailsButton.setText(DataTransferMessages
                .getString("DataTransfer.details")); //$NON-NLS-1$
    ...
    protected void displaySelectedCount(int selectedFileCount) {
        if (selectedFileCount == 1)
            detailsDescriptionLabel.setText(DataTransferMessages
                    .getString("DataTransfer.oneSelected")); //$NON-NLS-1$
        else
            detailsDescriptionLabel
                    .setText(DataTransferMessages
                            .format(
                                    "FileImport.filesSelected", new Object[] { String.valueOf(selectedFileCount) })); //$NON-NLS-1$
    }
        ...
        if (selectedResources == null && importAllResourcesRadio.getSelection()) {
            ...
            if (selectedResources.size() > 0) {
                ...
                while (resourcesEnum.hasNext())
                    fileSystemObjects.add(((FileSystemElement) resourcesEnum
    ...
    protected List getTypesToImport() {
        ...
        StringTokenizer tokenizer = new StringTokenizer(typesToImportField
    ...
    protected void handleTypesEditButtonPressed() {
        ...
        ListSelectionDialog dialog = new ListSelectionDialog(getContainer()
                ...
                FileEditorMappingLabelProvider.INSTANCE, DataTransferMessages
                        .getString("FileImport.selectTypes")); //$NON-NLS-1$

        dialog.setInitialSelections(initialSelections.toArray());
        dialog.setTitle(DataTransferMessages
                .getString("FileImport.typeSelectionTitle")); //$NON-NLS-1$
        dialog.open();
    ...
    protected void initializeOperation(ImportOperation op) {
        op.setCreateContainerStructure(createContainerStructureCheckbox
                .getSelection());
    ...
    protected List queryResourcesToImport(FileSystemElement rootElement) {
        FileSelectionDialog dialog = new FileSelectionDialog(getContainer()
                .getShell(), rootElement, DataTransferMessages
                .getString("FileImport.selectResources")); //$NON-NLS-1$
    ...
    protected void resetSelection() {
        detailsDescriptionLabel.setText(DataTransferMessages
                .getString("DataTransfer.allFiles")); //$NON-NLS-1$
    ...
    protected void restoreWidgetValues() {
        ...
        if (settings != null) {
            ...
            boolean importAll = settings
                    .getBoolean(STORE_IMPORT_ALL_RESOURCES_ID);
            ...
            createContainerStructureCheckbox.setSelection(settings
     ...
     */
    protected FileSystemElement selectFiles(Object rootFileSystemObject,
            IImportStructureProvider structureProvider) {
        try {
            SelectFilesOperation op = new SelectFilesOperation(
                    rootFileSystemObject, structureProvider);
    ...
    protected void updateWidgetEnablements() {
        ...
        typesToImportEditButton.setEnabled(importTypedResourcesRadio
                .getSelection());
    }
