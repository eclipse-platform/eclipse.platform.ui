...
public class InputImpl extends EObjectImpl implements MInput {
	...
	protected EClass eStaticClass() {
		return MApplicationPackage.Literals.INPUT;
	}
	...
	public void setInputURI(String newInputURI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MApplicationPackage.INPUT__INPUT_URI, oldInputURI, inputURI));
	}
