...
public interface MApplicationPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int PART_DESCRIPTOR__STYLE = PART__STYLE;
	 ...
	 * @ordered
	 */
	int MODEL_COMPONENT__STYLE = APPLICATION_ELEMENT__STYLE;
