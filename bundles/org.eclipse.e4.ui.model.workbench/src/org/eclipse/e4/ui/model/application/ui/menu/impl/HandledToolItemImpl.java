...
public class HandledToolItemImpl extends ToolItemImpl implements MHandledToolItem {
		...
		if (command != null && ((EObject)command).eIsProxy()) {
			...
			if (command != oldCommand) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MenuPackageImpl.HANDLED_TOOL_ITEM__COMMAND, oldCommand, command));
			}
		}
		return command;
	}
	...
	public void setCommand(MCommand newCommand) {
		...
		command = newCommand;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MenuPackageImpl.HANDLED_TOOL_ITEM__COMMAND, oldCommand, command));
	}
	...
	public void setWbCommand(ParameterizedCommand newWbCommand) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MenuPackageImpl.HANDLED_TOOL_ITEM__WB_COMMAND, oldWbCommand, wbCommand));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == MHandledItem.class) {
			switch (derivedFeatureID) {
				case MenuPackageImpl.HANDLED_TOOL_ITEM__COMMAND: return MenuPackageImpl.HANDLED_ITEM__COMMAND;
				case MenuPackageImpl.HANDLED_TOOL_ITEM__WB_COMMAND: return MenuPackageImpl.HANDLED_ITEM__WB_COMMAND;
				case MenuPackageImpl.HANDLED_TOOL_ITEM__PARAMETERS: return MenuPackageImpl.HANDLED_ITEM__PARAMETERS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == MHandledItem.class) {
			switch (baseFeatureID) {
				case MenuPackageImpl.HANDLED_ITEM__COMMAND: return MenuPackageImpl.HANDLED_TOOL_ITEM__COMMAND;
				case MenuPackageImpl.HANDLED_ITEM__WB_COMMAND: return MenuPackageImpl.HANDLED_TOOL_ITEM__WB_COMMAND;
				case MenuPackageImpl.HANDLED_ITEM__PARAMETERS: return MenuPackageImpl.HANDLED_TOOL_ITEM__PARAMETERS;
				default: return -1;
			}
		}
