...
public class DirectToolItemImpl extends ToolItemImpl implements MDirectToolItem {
	...
	public void setContributionURI(String newContributionURI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MenuPackageImpl.DIRECT_TOOL_ITEM__CONTRIBUTION_URI,
	...
	public void setObject(Object newObject) {
		...
		object = newObject;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MenuPackageImpl.DIRECT_TOOL_ITEM__OBJECT, oldObject,
					object));
	}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == MContribution.class) {
			...
			case ApplicationPackageImpl.CONTRIBUTION__CONTRIBUTION_URI:
				return MenuPackageImpl.DIRECT_TOOL_ITEM__CONTRIBUTION_URI;
			case ApplicationPackageImpl.CONTRIBUTION__OBJECT:
				return MenuPackageImpl.DIRECT_TOOL_ITEM__OBJECT;
			default:
				return -1;
			}
		}
