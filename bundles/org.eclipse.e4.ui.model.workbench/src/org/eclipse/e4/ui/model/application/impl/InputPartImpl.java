 ...
 * <ul>
 *   <li>{@link org.eclipse.e4.ui.model.application.impl.InputPartImpl#getInputURI <em>Input URI</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InputPartImpl extends PartImpl implements MInputPart {
	...
	protected EClass eStaticClass() {
		return MApplicationPackage.Literals.INPUT_PART;
	}
	...
	public void setInputURI(String newInputURI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MApplicationPackage.INPUT_PART__INPUT_URI, oldInputURI, inputURI));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == MInput.class) {
			switch (derivedFeatureID) {
				case MApplicationPackage.INPUT_PART__INPUT_URI: return MApplicationPackage.INPUT__INPUT_URI;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == MInput.class) {
			switch (baseFeatureID) {
				case MApplicationPackage.INPUT__INPUT_URI: return MApplicationPackage.INPUT_PART__INPUT_URI;
				default: return -1;
			}
		}
