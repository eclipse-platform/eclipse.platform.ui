 ...
 *   <li>{@link org.eclipse.e4.ui.model.application.impl.ToolItemImpl#getSelectedElement <em>Selected Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ToolItemImpl extends ItemImpl implements MToolItem {
		...
		if (selectedElement != null && ((EObject)selectedElement).eIsProxy()) {
			...
			if (selectedElement != oldSelectedElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MApplicationPackage.TOOL_ITEM__SELECTED_ELEMENT, oldSelectedElement, selectedElement));
			}
		}
	...
	public void setSelectedElement(MMenuItem newSelectedElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MApplicationPackage.TOOL_ITEM__SELECTED_ELEMENT, oldSelectedElement, selectedElement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MApplicationPackage.TOOL_ITEM__CHILDREN:
				return getChildren();
			case MApplicationPackage.TOOL_ITEM__SELECTED_ELEMENT:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == MElementContainer.class) {
			switch (derivedFeatureID) {
				...
				case MApplicationPackage.TOOL_ITEM__SELECTED_ELEMENT: return MApplicationPackage.ELEMENT_CONTAINER__SELECTED_ELEMENT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == MElementContainer.class) {
			switch (baseFeatureID) {
				...
				case MApplicationPackage.ELEMENT_CONTAINER__SELECTED_ELEMENT: return MApplicationPackage.TOOL_ITEM__SELECTED_ELEMENT;
				default: return -1;
			}
		}
