...
public class KeyStroke extends Trigger implements Comparable {
     ...
     */
    public static final KeyStroke getInstance(final ModifierKey modifierKey,
     ...
     */
    public static final KeyStroke getInstance(final NaturalKey naturalKey) {
     ...
     *            not be <code>null</code>. If this set is not empty, it must
     *            only contain instances of <code>ModifierKey</code>.
     * @param naturalKey
     *            the natural key. May be <code>null</code>.
     * @return a key stroke. Guaranteed not to be <code>null</code>.
     */
    public static final KeyStroke getInstance(final SortedSet modifierKeys,
            final NaturalKey naturalKey) {
        ...
        while (stringTokenizer.hasMoreTokens()) {
            ...
            if (i % 2 == 0) {
                if (stringTokenizer.hasMoreTokens()) {
                    ...
                    final ModifierKey modifierKey = (ModifierKey) ModifierKey.modifierKeysByName
                            .get(token);
     ...
     */
    private transient final ModifierKey[] modifierKeysAsArray;
    ...
    public final boolean equals(final Object object) {
        ...
        final KeyStroke castedObject = (KeyStroke) object;
        boolean equals = true;
