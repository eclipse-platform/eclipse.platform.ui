...
public class JFaceResources {
	...
	private static final ResourceBundle bundle =
		ResourceBundle.getBundle("org.eclipse.jface.messages");
	//$NON-NLS-1$
	...
	/**
	 * The symbolic font name for the standard font (value <code>"org.eclipse.jface.defaultfont"</code>).
	 */

	public static final String DEFAULT_FONT = "org.eclipse.jface.defaultfont"; //$NON-NLS-1$

	/**
	 * The symbolic font name for the dialog font (value <code>"org.eclipse.jface.dialogfont"</code>).
	 */
	public static final String DIALOG_FONT = "org.eclipse.jface.dialogfont"; //$NON-NLS-1$

	/**
	 * The symbolic font name for the banner font (value <code>"org.eclipse.jface.bannerfont"</code>).
	 */
	public static final String BANNER_FONT = "org.eclipse.jface.bannerfont"; //$NON-NLS-1$

	/**
	 * The symbolic font name for the viewer font (value <code>"org.eclipse.jface.viewerfont"</code>).
	 * 
	...
	/**
	 * The symbolic font name for the header font (value <code>"org.eclipse.jface.headerfont"</code>).
	 */
	public static final String HEADER_FONT = "org.eclipse.jface.headerfont"; //$NON-NLS-1$

	/**
	 * The symbolic font name for the text font (value <code>"org.eclipse.jface.textfont"</code>).
	 */
	public static final String TEXT_FONT = "org.eclipse.jface.textfont"; //$NON-NLS-1$

	/**
	 * The symbolic font name for the s font (value <code>"org.eclipse.jface.windowfont"</code>).
	 * 
	 * @deprecated This font is not in use
	 */
	 ...
	 * obtained from <code>ResourceBundle.getBundle("org.eclipse.jface.jface_nls")</code>.
	 * <p>
	 ...
	 * initialized to <code>new FontRegistry("org.eclipse.jface.resource.jfacefonts")</code>.
	 * <p>
	 * Note that several static convenience methods are also provided on this
	 ...
	 * called once; the call must occur before <code>JFaceResources.getFontRegistry</code>
