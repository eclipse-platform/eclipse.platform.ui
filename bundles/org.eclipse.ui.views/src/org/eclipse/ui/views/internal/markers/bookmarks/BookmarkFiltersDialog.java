...
class BookmarkFiltersDialog extends org.eclipse.ui.views.internal.markers.FiltersDialog {
		...
		public DescriptionGroup(Composite parent) {
			...
			description.addModifyListener(new ModifyListener() {
				public void modifyText(ModifyEvent e) {
					BookmarkFiltersDialog.this.markDirty();
				}
			});
		}
	 ...
	 * @param filter
	 */
	public BookmarkFiltersDialog(Shell parentShell, BookmarkFilter filter) {
