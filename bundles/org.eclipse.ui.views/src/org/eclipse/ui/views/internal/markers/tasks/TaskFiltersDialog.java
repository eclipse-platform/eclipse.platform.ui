...
class TaskFiltersDialog extends org.eclipse.ui.views.internal.markers.FiltersDialog {
		...
		public DescriptionGroup(Composite parent) {
			...
			description.addModifyListener(new ModifyListener() {
				public void modifyText(ModifyEvent e) {
					TaskFiltersDialog.this.markDirty();
				}
			});
		}
	 ...
	 * @param filter
	 */
	public TaskFiltersDialog(Shell parentShell, TaskFilter filter) {
