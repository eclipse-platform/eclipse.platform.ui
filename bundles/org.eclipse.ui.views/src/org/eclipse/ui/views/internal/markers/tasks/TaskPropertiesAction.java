...
class TaskPropertiesAction extends SelectionProviderAction {
	 ...
	 * @param text
	 */
	protected TaskPropertiesAction(IWorkbenchPart part, ISelectionProvider provider) {
	...
	public void run() {
		...
		MarkerPropertiesDialog dialog = new TaskPropertiesDialog(part.getSite().getShell());
