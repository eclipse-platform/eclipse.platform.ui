...
class Priority implements IField {
	...
	public Image getImage(Object obj) {
		...
		try {
			int priority = Integer.parseInt(MarkerUtil.getProperty(name, (IMarker) obj));
	...
	public int compare(Object obj1, Object obj2) {
		...
		int priority1 = -1;
		try {
			priority1 = Integer.parseInt(MarkerUtil.getProperty(name, (IMarker) obj1));
		}
		catch (NumberFormatException e) {
		}
		int priority2 = -1;
		try {
			priority2 = Integer.parseInt(MarkerUtil.getProperty(name, (IMarker) obj2));
		}
		catch (NumberFormatException e) {
		}
