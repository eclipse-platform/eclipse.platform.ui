 ...
 */
class CopyMarkerAction extends SelectionProviderAction {
	 ...
	 * Creates the action.
	 */
	public CopyMarkerAction(IWorkbenchPart part, ISelectionProvider provider) {
	 ...
	 * @param properties
	 */
	public void setProperties(IField[] properties) {
