...
class MarkerPropertiesAction extends SelectionProviderAction {
	 ...
	 * @param text
	 */
	protected MarkerPropertiesAction(IWorkbenchPart part, ISelectionProvider provider) {
	...
	public void run() {
		...
		MarkerPropertiesDialog dialog = new MarkerPropertiesDialog(part.getSite().getShell());
