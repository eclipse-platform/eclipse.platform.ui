...
class ProblemPropertiesAction extends SelectionProviderAction {
	 ...
	 * @param text
	 */
	protected ProblemPropertiesAction(IWorkbenchPart part, ISelectionProvider provider) {
	...
	public void run() {
		...
		MarkerPropertiesDialog dialog = new ProblemPropertiesDialog(part.getSite().getShell());
