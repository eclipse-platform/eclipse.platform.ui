...
public class BrowserDescriptor implements IBrowserDescriptor {
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ui.browser.internal.IWebBrowser#getName()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ui.browser.internal.IBrowserDescriptor#getLocation()
	 */
	...
	/* (non-Javadoc)
	 * @see org.eclipse.ui.browser.internal.IBrowserDescriptor#getParameters()
	 */
