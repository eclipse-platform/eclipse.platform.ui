...
public class WebBrowserPreferencePage extends PreferencePage implements
	...
	protected Control createContents(Composite parent) {
		...
		internal
				.setText(WebBrowserUIPlugin.getResource("%prefInternalBrowser"));
		data = new GridData(GridData.HORIZONTAL_ALIGN_BEGINNING);
		data.horizontalSpan = 2;
		...
		external
				.setText(WebBrowserUIPlugin.getResource("%prefExternalBrowser"));
		data = new GridData(GridData.HORIZONTAL_ALIGN_BEGINNING);
		data.horizontalSpan = 2;
		...
		final Button add = SWTUtil.createButton(buttonComp, WebBrowserUIPlugin
				.getResource("%add"));
		...
		search.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				...
				dialog.setMessage(WebBrowserUIPlugin
						.getResource("%selectDirectory"));
				dialog.setText(WebBrowserUIPlugin
						.getResource("%directoryDialogTitle"));
