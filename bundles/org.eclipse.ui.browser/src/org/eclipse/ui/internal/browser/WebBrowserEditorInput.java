...
public class WebBrowserEditorInput implements IEditorInput, IPersistableElement, IElementFactory {
	 ...
	 *
	 * @param input org.eclipse.ui.internal.browser.IWebBrowserEditorInput
	 * @return boolean
	 */
	...
	public IAdaptable createElement(IMemento memento) {
		...
		int newStyle = 0; //ExternalBrowserInstance.SHOW_TOOLBAR | ExternalBrowserInstance.SHOW_STATUSBAR;
		try {
	...
	/*public boolean isLocationBarGlobal() {
		return (style & ExternalBrowserInstance.LOCATION_TOOLBAR) != 0;
	}*/
	...
	/*public boolean isToolbarGlobal() {
		return (style & ExternalBrowserInstance.BUTTON_TOOLBAR) != 0;
	}*/
