...
public class Messages {
	...
	public static String resources_settingDefaultCharsetWorkspace;
	...
	static {
		...
		Platform.initializeMessages("org.eclipse.core.internal.utils.messages", Messages.class); //$NON-NLS-1$
	}
	...
	public static String bind(String message) {
		return bind(message, (String[]) null);
	}
