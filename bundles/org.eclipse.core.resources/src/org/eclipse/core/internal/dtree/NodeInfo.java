...
public class NodeInfo {
	...
	public boolean hasData() {
		return (type == AbstractDataTreeNode.T_COMPLETE_NODE || type == AbstractDataTreeNode.T_DELTA_NODE);
	}
	...
	static NodeInfo missing() {
		return new NodeInfo(AbstractDataTreeNode.T_MISSING_NODE, null, //no data
