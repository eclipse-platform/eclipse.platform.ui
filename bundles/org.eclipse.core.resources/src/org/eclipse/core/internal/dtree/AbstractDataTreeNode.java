...
public abstract class AbstractDataTreeNode {
	 ...
	 */
	abstract AbstractDataTreeNode asBackwardDelta (DeltaDataTree myTree, 
...
AbstractDataTreeNode asReverseComparisonNode(IComparator comparator) {
	...
	static AbstractDataTreeNode[] assembleWith(
		AbstractDataTreeNode[] oldNodes, 
		AbstractDataTreeNode[] newNodes,
		boolean keepDeleted) {
	 ...
	 */
	 AbstractDataTreeNode childAt(String localName) {
		...
		throw new ObjectNotFoundException("Missing child node: " + localName);
	}
	/**
...
static AbstractDataTreeNode convertToRemovedComparisonNode(AbstractDataTreeNode oldNode, int userComparison) {
	 ...
	 */
	 protected void copyChildren(int from, int to, 
	 	AbstractDataTreeNode otherNode, int start) {
	 ...
	 */
	Object getData() {
		throw new AbstractMethodError ("Subclass should have implemented this");
	}
	/**
...
public static void sort(AbstractDataTreeNode[] list) {
	...
	public String toString () {
		...
		return "an AbstractDataTreeNode(" + this.getName() + ") with " + 
