...
static void handleImmutableTree() {
	throw new ObjectNotFoundException("Illegal attempt to modify an immutable tree");
}
/**
...
static void handleNotFound(IPath key) {
	throw new ObjectNotFoundException("Attempted to reference non-existent tree element: " + key);
}
	/**
	...
	void setRootNode(AbstractDataTreeNode node) {
		throw new Error ("Subclass should have implemented this");
	}
