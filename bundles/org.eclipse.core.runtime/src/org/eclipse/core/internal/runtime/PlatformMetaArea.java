...
public class PlatformMetaArea {
	...
	/* package */
	static final String F_DESCRIPTION = ".platform"; //$NON-NLS-1$
	/* package */
	static final String F_META_AREA = ".metadata"; //$NON-NLS-1$
	/* package */
	static final String F_PLUGIN_PATH = ".plugin-path"; //$NON-NLS-1$
	/* package */
	static final String F_PLUGIN_DATA = ".plugins"; //$NON-NLS-1$
	/* package */
	static final String F_REGISTRY = ".registry"; //$NON-NLS-1$
	/* package */
	static final String F_SNAP = ".snap"; //$NON-NLS-1$
	/* package */
	static final String F_LOG = ".log"; //$NON-NLS-1$
	/* package */
	static final String F_BACKUP = ".bak"; //$NON-NLS-1$
	/* package */
	static final String F_OPTIONS = ".options"; //$NON-NLS-1$
	/* package */
	static final String F_KEYRING = ".keyring"; //$NON-NLS-1$
	/* package */
	static final String F_LOCK_FILE = ".lock"; //$NON-NLS-1$
	/* package */
	static final String F_VERSION = "version.ini"; //$NON-NLS-1$
	/**
	...
	public Hashtable readPluginPath(IPath location) throws CoreException {
		...
		try {
			...
			IStatus status = new Status(IStatus.ERROR, IPlatform.PI_RUNTIME, IPlatform.FAILED_READ_METADATA, message, e);
	...
	public void writePluginPath(Hashtable paths, IPath location) throws CoreException {
		...
		try {
			...
			IStatus status = new Status(IStatus.ERROR, IPlatform.PI_RUNTIME, IPlatform.FAILED_WRITE_METADATA, message, e);
			throw new CoreException(status);
		}
	}
