 ...
 * the ability of scanning character streams. Describers for text-based 
 * content types are supposed to implement this interface instead of 
 * <code>IContentDescription</code>. * 
 * <p>
