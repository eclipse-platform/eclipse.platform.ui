 ...
 *
 */
public class BindingModelProperty extends SimpleValueProperty<Binding, IObservable> {
	@Override
	...
	protected void doAddListener(Binding source, INativePropertyListener<Binding> listener) {
	}

	protected void doRemoveListener(Binding source, INativePropertyListener<Binding> listener) {
	}
