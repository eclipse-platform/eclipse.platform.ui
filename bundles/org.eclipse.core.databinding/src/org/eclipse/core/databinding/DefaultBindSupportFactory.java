	...
	private Map getConverterMap() {
		...
		if (converterMap == null) {
			...
			converterMap
					.put(
							new Pair(
									"java.lang.String", INTEGER_TYPE), "org.eclipse.core.databinding.conversion.ConvertString2IntegerPrimitive"); //$NON-NLS-1$ //$NON-NLS-2$
			converterMap
					.put(
							new Pair(
			...
			converterMap
					.put(
							new Pair(
									"java.lang.String", BYTE_TYPE), "org.eclipse.core.databinding.conversion.ConvertString2BytePrimitive"); //$NON-NLS-1$ //$NON-NLS-2$
			converterMap
					.put(
							new Pair(
			...
			converterMap
					.put(
							new Pair(
									"java.lang.String", DOUBLE_TYPE), "org.eclipse.core.databinding.conversion.ConvertString2DoublePrimitive"); //$NON-NLS-1$ //$NON-NLS-2$
			converterMap
					.put(
							new Pair(
			...
			converterMap
					.put(
							new Pair(
									"java.lang.String", BOOLEAN_TYPE), "org.eclipse.core.databinding.conversion.ConvertString2BooleanPrimitive"); //$NON-NLS-1$ //$NON-NLS-2$
			converterMap
					.put(
							new Pair(
			...
			converterMap
					.put(
							new Pair(
									"java.lang.String", FLOAT_TYPE), "org.eclipse.core.databinding.conversion.ConvertString2FloatPrimitive"); //$NON-NLS-1$ //$NON-NLS-2$
			converterMap
					.put(
							new Pair(
			...
			converterMap
					.put(
							new Pair(
									"java.lang.String", SHORT_TYPE), "org.eclipse.core.databinding.conversion.ConvertString2ShortPrimitive"); //$NON-NLS-1$ //$NON-NLS-2$
			converterMap
					.put(
							new Pair(
			...
			converterMap
					.put(
							new Pair(
									"java.lang.String", LONG_TYPE), "org.eclipse.core.databinding.conversion.ConvertString2LongPrimitive"); //$NON-NLS-1$ //$NON-NLS-2$
			converterMap
					.put(
							new Pair(
