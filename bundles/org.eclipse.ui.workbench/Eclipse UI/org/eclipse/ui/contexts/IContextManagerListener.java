...
public interface IContextManagerListener {
	...
	/**
	 * Notifies that one or more properties of an instance of <code>IContextManager</code>
	 * have changed. Specific details are described in the <code>ContextManagerEvent</code>.
	 * 
	 * @param contextManagerEvent
	 *            the context manager event. Guaranteed not to be <code>null</code>.
	 */
