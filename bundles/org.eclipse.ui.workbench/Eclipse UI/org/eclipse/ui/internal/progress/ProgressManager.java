...
public class ProgressManager extends ProgressProvider implements
    ...
    final static String[] keys = new String[] { PROGRESS_20_KEY,
            PROGRESS_40_KEY, PROGRESS_60_KEY, PROGRESS_80_KEY, PROGRESS_100_KEY};
    ...
    public static ProgressManager getInstance() {
        if (singleton == null) singleton = new ProgressManager();
        return singleton;
    }
    ...
    class JobMonitor implements IProgressMonitorWithBlocking {
        ...
        public void beginTask(String taskName, int totalWork) {
            ...
            if (listener != null) listener.beginTask(taskName, totalWork);
        }
        ...
        public void internalWorked(double work) {
            ...
            if (listener != null) listener.internalWorked(work);
        }
        ...
        public void setCanceled(boolean value) {
            ...
            if (value && !info.isCanceled()) info.cancel();
            if (listener != null) listener.setCanceled(value);
        }
        ...
        public void setTaskName(String taskName) {
            ...
            refreshJobInfo(info);
            currentTaskName = taskName;
            if (listener != null) listener.setTaskName(taskName);
        }
        ...
        public void subTask(String name) {
            ...
            refreshJobInfo(info);
            if (listener != null) listener.subTask(name);
        }
        ...
        public void clearBlocked() {
            ...
            refreshJobInfo(info);
            if (listener != null) listener.clearBlocked();
        ...
        public void setBlocked(IStatus reason) {
            ...
            info.setBlockedStatus(null);
            refreshJobInfo(info);
            if (listener != null) listener.setBlocked(reason);
        }
    }
    ...
    private void createChangeListener() {
        ...
        changeListener = new JobChangeAdapter() {
            ...
            public void scheduled(IJobChangeEvent event) {
                if (isNeverDisplayedJob(event.getJob())) return;
    ...
    public IProgressMonitor getDefaultMonitor() {
        ...
        if (PlatformUI.isWorkbenchRunning()) {
            ...
            if (!display.isDisposed()
                    ...
                    return new EventLoopProgressMonitor(
    ...
    public void refreshJobInfo(JobInfo info) {
        ...
        if (group != null) refreshGroup(group);
    ...
    boolean isNonDisplayableJob(Job job, boolean debug) {
        if (isNeverDisplayedJob(job)) return true;
    ...
    private boolean hasNoRegularJobInfos() {
        synchronized (jobs) {
            ...
            while (iterator.hasNext()) {
                Job next = (Job) iterator.next();
                if (!isNonDisplayableJob(next, false)) return false;
            }
            return true;
        }
    }
