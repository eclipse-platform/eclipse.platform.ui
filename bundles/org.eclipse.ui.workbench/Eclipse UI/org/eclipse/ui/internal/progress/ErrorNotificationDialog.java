...
public class ErrorNotificationDialog extends Dialog {
	...
	protected void configureShell(Shell newShell) {
		...
		newShell.setText(ProgressMessages.getString("ErrorNotificationDialog.ErrorNotificationTitle")); //$NON-NLS-1$
	...
	private void createClearSelectionAction() {
			clearSelectionAction = new Action(ProgressMessages.getString("ErrorNotificationDialog.ClearSelectionAction")) {//$NON-NLS-1$
	/* (non-Javadoc)
	 * @see org.eclipse.jface.action.Action#run()
	 */
			public void run() {
