 ...
 * workbench progress.
 */
public class NewJobView extends ViewPart implements IViewPart {
    ...
    public void createPartControl(Composite parent) {
    	viewer = new JobsProgressViewer(parent, SWT.MULTI | SWT.H_SCROLL
                | SWT.V_SCROLL);
    ...
    protected void initContentProvider() {
        IContentProvider provider = new JobsProgressViewerContentProvider(viewer);
