...
public class WorkbenchWizardElement extends WorkbenchAdapter implements IAdaptable,
		IPluginContribution, IWizardDescriptor {
	private String id;
	...
	public ImageDescriptor getImageDescriptor() {
		if (imageDescriptor == null) {
			...
			imageDescriptor = AbstractUIPlugin.imageDescriptorFromPlugin(configurationElement
	...
	public String getPluginId() {
		return (configurationElement != null) ? configurationElement.getNamespaceIdentifier()
				: null;
	}
	...
	public ImageDescriptor getDescriptionImage() {
		if (descriptionImage == null) {
			...
			descriptionImage = AbstractUIPlugin.imageDescriptorFromPlugin(configurationElement
					.getNamespaceIdentifier(), descImage);
		}
