...
public class WorkbenchPreferenceDialog extends FilteredPreferenceDialog {
    ...
    protected void loadPressed() {
        PreferenceImportExportWizard wizard = new PreferenceImportExportWizard(
                false, this);
        IDialogSettings workbenchSettings = WorkbenchPlugin.getDefault()
                .getDialogSettings();
        IDialogSettings wizardSettings = workbenchSettings
                .getSection(FILE_PATH_SETTING); //$NON-NLS-1$
        ...
        Point childLocation = new Point((parentSize.x - childSize.x) / 2,
    ...
    protected void savePressed() {
        ...
        if (wizardSettings == null)
            wizardSettings = workbenchSettings
                    .addNewSection("ExportPreferencesWizard"); //$NON-NLS-1$
        wizard.setDialogSettings(wizardSettings);
