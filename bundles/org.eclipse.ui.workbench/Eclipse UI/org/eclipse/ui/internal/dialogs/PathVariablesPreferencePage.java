 ...
 */
public class PathVariablesPreferencePage
...
private void editSelectedVariable() {
    ...
    PathVariableDialog dialog = new PathVariableDialog(this.getShell(),PathVariableDialog.EXISTING_VARIABLE,pathVariableManager,tempPathVariables.keySet());
...
private void addNewVariable() {
    ...
    PathVariableDialog dialog = new PathVariableDialog(this.getShell(),PathVariableDialog.NEW_VARIABLE,pathVariableManager,tempPathVariables.keySet());
