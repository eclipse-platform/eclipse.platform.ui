...
final class Persistence {
    ...
    static List readActivityRequirementBindingDefinitions(IMemento memento,
        ...
        for (int i = 0; i < mementos.length; i++)
            list.add(readActivityRequirementBindingDefinition(mementos[i],
                    sourceIdOverride));
    ...
    static List readActivityPatternBindingDefinitions(IMemento memento,
        ...
        for (int i = 0; i < mementos.length; i++)
            list.add(readActivityPatternBindingDefinition(mementos[i],
                    sourceIdOverride));
    ...
    static List readCategoryActivityBindingDefinitions(IMemento memento,
        ...
        for (int i = 0; i < mementos.length; i++)
            list.add(readCategoryActivityBindingDefinition(mementos[i],
                    sourceIdOverride));
