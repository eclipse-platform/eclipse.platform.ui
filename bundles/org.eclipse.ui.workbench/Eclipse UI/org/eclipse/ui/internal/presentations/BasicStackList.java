...
public class BasicStackList extends AbstractTableInformationControl {
    ...
    private class BasicStackListLabelProvider extends LabelProvider implements
        ...
        public String getText(Object element) {
            ...
            DefaultPartPresentation basicStackPresentation = (DefaultPartPresentation) getTableViewer()
                    .getInput();
            IPresentablePart presentablePart = basicStackPresentation
                    .getPartForTab(tabItem);
    ...
    public void setInput(Object information) {
        ...
        inputChanged(basicStackPresentation, basicStackPresentation
                .getTabFolder().getSelection());
    }
    ...
    protected boolean deleteSelectedElements() {
        ...
        if (structuredSelection != null) {
            ...
            for (Iterator iterator = structuredSelection.iterator(); iterator
                    .hasNext();) {
                IPresentablePart presentablePart = basicStackPresentation
                        .getPartForTab((CTabItem) iterator.next());
                list.add(presentablePart);
            }

            basicStackPresentation.close((IPresentablePart[]) list
                    .toArray(new IPresentablePart[list.size()]));
        }

        if (((DefaultPartPresentation) getTableViewer().getInput())
                .isDisposed()) {
            fComposite.dispose();
            return true;
        }
