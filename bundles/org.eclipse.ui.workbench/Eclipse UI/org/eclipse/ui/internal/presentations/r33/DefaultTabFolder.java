...
public class DefaultTabFolder extends AbstractTabFolder {
	...
	private PaneFolderButtonListener buttonListener = new PaneFolderButtonListener() {
		 ...
		 * 
		 * @param item
		 *            the tab whose close button was pressed
		 */
	...
	private DefaultTabFolderColors[] activeShellColors = { defaultColors,
			defaultColors, defaultColors };
	private DefaultTabFolderColors[] inactiveShellColors = { defaultColors,
			defaultColors, defaultColors };
	 ...
	 * @param allowMax
	 */
	public DefaultTabFolder(Composite parent, int flags, boolean allowMin,
			boolean allowMax) {
	...
	public AbstractTabItem add(int index, int flags) {
		DefaultTabItem result = new DefaultTabItem((CTabFolder) getFolder()
				.getControl(), index, flags);
	...
	public Rectangle getTabArea() {
		return Geometry.toDisplay(paneFolder.getControl(), paneFolder
				.getTitleArea());
	}
	...
	public Point getPartListLocation() {
		return paneFolder.getControl().toDisplay(
				paneFolder.getChevronLocation());
	}
	...
	public void setColors(DefaultTabFolderColors colors, int activationState,
		...
		if (activationState == getActive()
				&& shellActive == shellActivationState) {
			updateColors(activationState);
		}
	}
	...
	private void updateColors(int activationState) {
		DefaultTabFolderColors currentColors = shellActive ? activeShellColors[getActive()]
