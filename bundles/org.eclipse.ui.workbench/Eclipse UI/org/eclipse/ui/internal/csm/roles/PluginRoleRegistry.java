...
final class PluginRoleRegistry extends AbstractRoleRegistry {
	...
	private final class PluginRegistryReader extends RegistryReader {
		...
		protected boolean readElement(IConfigurationElement element) {
			...
			if (Persistence.TAG_ACTIVITY_BINDING.equals(name))
				return readActivityBindingDefinition(element);
	...
	private boolean readActivityBindingDefinition(IConfigurationElement element) {
		IActivityBindingDefinition activityBindingDefinition = Persistence.readActivityBindingDefinition(new ConfigurationElementMemento(element), getPluginId(element));
