...
public final class ActivityService implements IActivityService {
	...
	private IActivityServiceEvent activityActivationServiceEvent;
	...
	public void addActivityActivationServiceListener(IActivityServiceListener activityActivationServiceListener) {
	...
	public void removeActivityActivationServiceListener(IActivityServiceListener activityActivationServiceListener) {
		if (activityActivationServiceListener == null)
			throw new NullPointerException();
		...
		if (activityActivationServiceListeners != null) {
			for (int i = 0; i < activityActivationServiceListeners.size(); i++) {
				if (activityActivationServiceEvent == null)
					activityActivationServiceEvent = new ActivityServiceEvent(this);
							
				((IActivityServiceListener) activityActivationServiceListeners.get(i)).activityActivationServiceChanged(activityActivationServiceEvent);
			}				
		}	
	}	
}
