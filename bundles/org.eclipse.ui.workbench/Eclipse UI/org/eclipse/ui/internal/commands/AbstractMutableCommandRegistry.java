...
public abstract class AbstractMutableCommandRegistry extends
        AbstractCommandRegistry implements IMutableCommandRegistry {

    protected AbstractMutableCommandRegistry() {
        // Nothing to initialize.
    }

    public void setActiveKeyConfigurationDefinitions(
            List activeKeyConfigurationDefinitions) {
        activeKeyConfigurationDefinitions = Util.safeCopy(
    ...
    public void setCategoryDefinitions(List categoryDefinitions) {
        categoryDefinitions = Util.safeCopy(categoryDefinitions,
    ...
    public void setCommandDefinitions(List commandDefinitions) {
        commandDefinitions = Util.safeCopy(commandDefinitions,
    ...
    public void setKeyConfigurationDefinitions(List keyConfigurationDefinitions) {
        commandDefinitions = Util.safeCopy(keyConfigurationDefinitions,
    ...
    public void setKeySequenceBindingDefinitions(
            List keySequenceBindingDefinitions) {
        keySequenceBindingDefinitions = Util.safeCopy(
