...
public class KeyPreferencePage extends org.eclipse.jface.preference.PreferencePage
	implements IWorkbenchPreferencePage {
		...
		final class DialogCustomize extends Dialog {
			...
			private final ResourceBundle resourceBundle = ResourceBundle.getBundle(KeyPreferencePage.class.getName());
	
			private final String ACTION_CONFLICT = Util.getString(resourceBundle, "ActionConflict"); //$NON-NLS-1$
			private final String ACTION_UNDEFINED = Util.getString(resourceBundle, "ActionUndefined"); //$NON-NLS-1$
			...
			private final Image IMAGE_CHANGE = ImageFactory.getImage("change"); //$NON-NLS-1$
			private final Image IMAGE_MINUS = ImageFactory.getImage("minus"); //$NON-NLS-1$
			private final Image IMAGE_PLUS = ImageFactory.getImage("plus"); //$NON-NLS-1$
			private final RGB RGB_CONFLICT = new RGB(255, 0, 0);
			private final RGB RGB_CONFLICT_MINUS = new RGB(255, 192, 192);
			private final RGB RGB_MINUS =	new RGB(192, 192, 192);
