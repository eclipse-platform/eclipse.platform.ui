 ...
 */
public class CheckboxDoubleListGroup extends Composite implements
     ...
     */
    public CheckboxDoubleListGroup(Composite parent, Object rootObject,
            IStructuredContentProvider list1ContentProvider,
            ILabelProvider list1LabelProvider,
            IStructuredContentProvider list2ContentProvider,
            ILabelProvider list2LabelProvider, int style) {

        this(parent, rootObject, list1ContentProvider, list1LabelProvider,
                list2ContentProvider, list2LabelProvider, style, -1, -1);
    }
    ...
    public CheckboxDoubleListGroup(Composite parent, Object rootObject,
            ...
            ILabelProvider list1LabelProvider,
            IStructuredContentProvider list2ContentProvider,
            ILabelProvider list2LabelProvider, int style, int width, int height) {
    ...
    public void selectionChanged(SelectionChangedEvent event) {
        ...
        if (selectedElement != currentList1Selection) {
            ...
            List listItemsToCheck = (List) checkedStateStore
                    .get(selectedElement);
     ...
     */
    public void setList1Providers(IStructuredContentProvider contentProvider,
     ...
     *	@param labelProvider ILabelProvider
     */
    public void setList2Providers(IStructuredContentProvider contentProvider,
            ILabelProvider labelProvider) {
