...
class DecorationReference {
	...
	String getSubTask() {
		if (undecoratedText == null)
			return WorkbenchMessages.getString("DecorationReference.EmptyReference"); //$NON-NLS-1$
		else
			return WorkbenchMessages.format("DecorationScheduler.DecoratingSubtask", //$NON-NLS-1$
