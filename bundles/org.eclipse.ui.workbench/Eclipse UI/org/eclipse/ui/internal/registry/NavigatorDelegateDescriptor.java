 ...
 * @since 3.0
 */
public class NavigatorDelegateDescriptor extends NavigatorContentDescriptor {
	 ...
	 */
	public NavigatorDelegateDescriptor(IConfigurationElement configElement) throws WorkbenchException {
		super(configElement);
		readConfigElement();
	}
