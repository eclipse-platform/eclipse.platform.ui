...
public class WorkbenchWindow extends ApplicationWindow implements
	...
	private final void initializeDefaultServices() {
		...
		final IBindingService bindingService = (IBindingService) getService(IBindingService.class);
		final ICommandImageService commandImageService = (ICommandImageService) getService(ICommandImageService.class);
		final LegacyActionHandlerPersistence deprecatedSupport = new LegacyActionHandlerPersistence(
				commandService, handlerService, bindingService,
				commandImageService, sourceProviders);
