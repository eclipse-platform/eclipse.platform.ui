...
public class WWinPerspectiveService implements IPerspectiveService {
     ...
     */
    protected void firePerspectiveActivated(IWorkbenchPage page,
     ...
     */
    protected void firePerspectiveChanged(IWorkbenchPage page,
     ...
     */
    protected void firePerspectiveClosed(IWorkbenchPage page,
            IPerspectiveDescriptor perspective) {
     ...
     * Fires perspective reset
     */
    protected void firePerspectiveOpened(IWorkbenchPage page,
            IPerspectiveDescriptor perspective) {
