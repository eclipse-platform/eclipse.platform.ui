 ...
 * @since 3.0
 */
public class TemporaryGradientRegistry extends GradientRegistry {

    /**
     */
    public TemporaryGradientRegistry(GradientRegistry registry) {
        // do not hook listeners        
        Set keySet = registry.getKeySet();
        for (Iterator i = keySet.iterator(); i.hasNext();) {
            String key = (String) i.next();
            put(key, registry.getGradientData(key));
        }        
    }
