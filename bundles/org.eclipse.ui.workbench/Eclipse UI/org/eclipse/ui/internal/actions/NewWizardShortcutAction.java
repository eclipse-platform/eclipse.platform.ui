...
public class NewWizardShortcutAction extends Action implements IPluginContribution {
	 ...
	 * 
	 * @param window
	 *            the workbench window in which this action will appear
	 * @param wizardDesc
	 *            a wizard element
	 */
	...
	public void run() {
		...
		try {
			...
			ErrorDialog.openError(window.getShell(),
					WorkbenchMessages.NewWizardShortcutAction_errorTitle,
		...
		// if the wizard can finish early and doesn't have any pages, just
		// finish it.
	...
	private IPluginContribution getPluginContribution() {
		return (IPluginContribution) Util.getAdapter(wizardElement, IPluginContribution.class);
	}
}
