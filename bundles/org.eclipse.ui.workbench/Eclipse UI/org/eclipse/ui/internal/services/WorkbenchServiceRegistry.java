...
public class WorkbenchServiceRegistry implements IExtensionChangeHandler {
	...
	private Map<String, ServiceFactoryHandle> factories = new HashMap<>();
	...
	public void removeExtension(IExtension extension, Object[] objects) {
		for (Object object : objects) {
			if (object instanceof ServiceFactoryHandle) {
				...
				Set<ServiceLocator> locatorSet = handle.serviceLocators.keySet();
				ServiceLocator[] locators = locatorSet
