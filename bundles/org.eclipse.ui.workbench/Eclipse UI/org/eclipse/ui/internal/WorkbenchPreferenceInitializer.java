...
public class WorkbenchPreferenceInitializer extends
    ...
    public void initializeDefaultPreferences() {
        ...
        store.setDefault(IPreferenceConstants.SHOULD_PROMPT_FOR_ENABLEMENT,
                true);

        store
                .setDefault(IPreferenceConstants.EDITORLIST_PULLDOWN_ACTIVE,
                        false);
        store.setDefault(IPreferenceConstants.EDITORLIST_DISPLAY_FULL_NAME,
                false);
        ...
        store.setDefault(IPreferenceConstants.OPEN_PERSP_MODE,
                IPreferenceConstants.OPM_ACTIVE_PAGE);
        store.setDefault(IPreferenceConstants.ENABLED_DECORATORS, ""); //$NON-NLS-1$
        store.setDefault(IPreferenceConstants.EDITORLIST_SELECTION_SCOPE,
                IPreferenceConstants.EDITORLIST_SET_PAGE_SCOPE); // Current Window
        store.setDefault(IPreferenceConstants.EDITORLIST_SORT_CRITERIA,
        ...
        store.setDefault(IPreferenceConstants.CURRENT_THEME_ID,
