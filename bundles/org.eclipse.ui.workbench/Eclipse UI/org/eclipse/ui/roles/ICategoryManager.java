...
/**
 * <p>
 * An instance of <code>IRoleManager</code> can be used to obtain instances
 * of <code>IRole</code>.
 * </p>
 * <p>
...
public interface ICategoryManager {
	 ...
	 * 
	 * @param roleManagerListener
	 *            the instance of <code>IRoleManagerListener</code> to
	 *            register. Must not be <code>null</code>. If an attempt is
	 *            made to register an instance of <code>IRoleManagerListener</code>
	 ...
	 *            is made to unregister an instance of <code>IRoleManagerListener</code>
