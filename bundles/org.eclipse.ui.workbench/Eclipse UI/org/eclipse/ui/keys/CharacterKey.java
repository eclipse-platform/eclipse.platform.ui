...
/**
 * <p>
 * Instances of <code>CharacterKey</code> represent keys on the keyboard
...
public final class CharacterKey extends NaturalKey {
	 ...
	 * represents the 'BS' key.
	 */
	public final static CharacterKey BS =
		CharacterKey.getInstance(BS_CHARACTER);
	...
	/**
	 * The single static instance of <code>CharacterKey</code> which
	 * represents the 'CR' key.
	 */
	public final static CharacterKey CR =
		CharacterKey.getInstance(CR_CHARACTER);
	...
	/**
	 * The single static instance of <code>CharacterKey</code> which
	 * represents the 'DEL' key.
	 */
	public final static CharacterKey DEL =
		CharacterKey.getInstance(DEL_CHARACTER);
	...
	public final static CharacterKey ESC =
		CharacterKey.getInstance(ESC_CHARACTER);
	...
	/**
	 * The single static instance of <code>CharacterKey</code> which
	 * represents the 'FF' key.
	 */
	public final static CharacterKey FF =
		CharacterKey.getInstance(FF_CHARACTER);
	...
	/**
	 * The single static instance of <code>CharacterKey</code> which
	 * represents the 'LF' key.
	 */
	public final static CharacterKey LF =
		CharacterKey.getInstance(LF_CHARACTER);
	...
	/**
	 * The single static instance of <code>CharacterKey</code> which
	 * represents the 'NUL' key.
	 */
	public final static CharacterKey NUL =
		CharacterKey.getInstance(NUL_CHARACTER);
	...
	private final static ResourceBundle RESOURCE_BUNDLE =
		ResourceBundle.getBundle(CharacterKey.class.getName());
	...
	public final static CharacterKey SPACE =
		CharacterKey.getInstance(SPACE_CHARACTER);
	...
	public final static CharacterKey TAB =
		CharacterKey.getInstance(TAB_CHARACTER);
	...
	/**
	 * The single static instance of <code>CharacterKey</code> which
	 * represents the 'VT' key.
	 */
	public final static CharacterKey VT =
		CharacterKey.getInstance(VT_CHARACTER);
