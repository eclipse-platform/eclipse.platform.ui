...
public interface ICommandService {
	...
	/**
	 * Registers an instance of <code>ICommandServiceListener</code> to
	 * listen for changes to attributes of this instance.
	 * 
	 * @param commandServiceListener
	 *            the instance of <code>ICommandServiceListener</code> to
	 *            register. Must not be <code>null</code>. If an attempt is
	 *            made to register an instance of <code>ICommandServiceListener</code>
	 ...
	 *            is made to unregister an instance of <code>ICommandServiceListener</code>
