...
public final class CharOperation {
	 ...
	 * Answers true if the first array is identical character by character to a
	 * portion of the second array delimited from position secondStart
	 * (inclusive) to secondEnd(exclusive), otherwise false. The equality could
	 * be either case sensitive or case insensitive according to the value of
	 * the <code>isCaseSensitive</code> parameter.
	 * </p>
	 * <p>
	 * For example:
	 * </p>
	 ...
	 */
	public static final boolean equals(char[] first, char[] second,
			int secondStart, int secondEnd, boolean isCaseSensitive) {
		if (first == second)
			return true;
		if (first == null || second == null)
			return false;
		...
		if (isCaseSensitive) {
			...
			for (int i = first.length; --i >= 0;)
				if (Character.toLowerCase(first[i]) != Character
						.toLowerCase(second[i + secondStart]))
					return false;
		}
		return true;
	}
	...
	/**
	 * Replace all occurrences of characters to be replaced with the
	 * remplacement character in the given array. <br>
	 * <br>
	 * For example:
	 * <ol>
	...
	/**
	 * Replace all occurrences of characters to be replaced with the
	 * remplacement character in the given array from the start position
	 * (inclusive) to the end position (exclusive). <br>
	 * <br>
	 * For example:
	 * <ol>
	 * <li>
