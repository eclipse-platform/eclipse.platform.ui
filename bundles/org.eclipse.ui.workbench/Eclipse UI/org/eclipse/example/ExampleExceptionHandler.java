...
/**
 * Handler for exceptions and errors caught in the workbench event loop.
 ...
 * @since 3.0
 */
class ExampleExceptionHandler implements Window.IExceptionHandler {
	 ...
	 */
	public ExampleExceptionHandler(Workbench w) {
		workbench = w;
	}
	/**
		...
		try {
			...
			if (exceptionCount == 2) {
				...
				MessageBox box =
					new MessageBox(
						parent,
						SWT.ICON_ERROR | SWT.YES | SWT.NO | SWT.SYSTEM_MODAL);
	...
	private void log(Throwable t) {
		try {
			...
			WorkbenchPlugin.log(
				...
				new Status(IStatus.ERROR, PlatformUI.PLUGIN_ID, 0, msg, t));
	...
	message, detail, InternalErrorDialog.QUESTION, labels, defaultIndex);
