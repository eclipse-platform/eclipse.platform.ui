...
public class ProgressInfoItem extends Composite {
	...
	static {
		JFaceResources.getImageRegistry().put(STOP_IMAGE_KEY,
				WorkbenchImages.getWorkbenchImageDescriptor("elcl16/progress_stop.svg"));//$NON-NLS-1$
		...
		JFaceResources.getImageRegistry().put(CLEAR_FINISHED_JOB_KEY,
				WorkbenchImages.getWorkbenchImageDescriptor("elcl16/progress_rem.svg")); //$NON-NLS-1$
