...
private Font defaultFont() {
	Object result = stringToFont.get(JFaceResources.DEFAULT_FONT);
	if (result != null)
		return (Font) result;
	//Make sure the default font data is initialized.
	defaultFontData();
	return get(JFaceResources.DEFAULT_FONT);
}
/**
 * Returns the default font data.  Creates it if necessary.
 */
private FontData[] defaultFontData() {
	Object result = stringToFontData.get(JFaceResources.DEFAULT_FONT);
	if (result == null) {
