 ...
 * </p>
 */
public class SelectMarkerRulerInfoAction extends ResourceAction implements IUpdate {
	...
	protected List getMarkers() {
		...
		if (resource != null && model != null) {
			try {
				...
				handleCoreException(x, EditorMessages.getString("SelectMarkerRulerInfoAction.getMarker")); //$NON-NLS-1$
			}
		}
