...
class EncodingRegistryReader extends RegistryReader {
	...
	protected boolean readElement(IConfigurationElement element) {
		...
		EncodingDefinition definition= new EncodingDefinition(id, label, value);
	...
	/*
	 * @see RegistryReader.readRegistry(IPluginRegistry)
	 */
	List readRegistry(IPluginRegistry in) {
		fgDefinitions= new ArrayList();
		readRegistry(in, IWorkbenchConstants.PLUGIN_ID, EXTENSION_ID);
		return fgDefinitions;
	}
