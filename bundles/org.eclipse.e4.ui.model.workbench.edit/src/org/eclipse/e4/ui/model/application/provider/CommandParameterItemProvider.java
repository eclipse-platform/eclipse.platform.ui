...
/**
 * This is the item provider adapter for a {@link org.eclipse.e4.ui.model.application.MCommandParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommandParameterItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MApplicationPackage.Literals.COMMAND_PARAMETER__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MApplicationPackage.Literals.COMMAND_PARAMETER__TYPE_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MApplicationPackage.Literals.COMMAND_PARAMETER__OPTIONAL,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MCommandParameter.class)) {
			case MApplicationPackage.COMMAND_PARAMETER__NAME:
			case MApplicationPackage.COMMAND_PARAMETER__TYPE_ID:
			case MApplicationPackage.COMMAND_PARAMETER__OPTIONAL:
