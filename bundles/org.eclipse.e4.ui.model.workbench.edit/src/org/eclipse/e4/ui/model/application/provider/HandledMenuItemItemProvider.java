...
/**
 * This is the item provider adapter for a {@link org.eclipse.e4.ui.model.application.MHandledMenuItem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HandledMenuItemItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MApplicationPackage.Literals.HANDLED_ITEM__COMMAND,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MApplicationPackage.Literals.HANDLED_ITEM__WB_COMMAND,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MApplicationPackage.Literals.HANDLED_ITEM__PARAMETERS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MHandledMenuItem.class)) {
			case MApplicationPackage.HANDLED_MENU_ITEM__WB_COMMAND:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case MApplicationPackage.HANDLED_MENU_ITEM__PARAMETERS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MApplicationPackage.Literals.HANDLED_ITEM__PARAMETERS,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			...
			childFeature == MApplicationPackage.Literals.HANDLED_ITEM__PARAMETERS;
