...
public class ExpressionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Expression_coreExpressionId_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_Expression_coreExpressionId_feature", "_UI_Expression_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 UiPackageImpl.Literals.EXPRESSION__CORE_EXPRESSION_ID,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((MExpression)object).getCoreExpressionId();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(MExpression.class)) {
