...
/**
 * This is the item provider adapter for a {@link org.eclipse.e4.ui.model.application.MKeyBinding} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class KeyBindingItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MApplicationPackage.Literals.KEY_SEQUENCE__KEY_SEQUENCE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MApplicationPackage.Literals.KEY_BINDING__COMMAND,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MApplicationPackage.Literals.KEY_BINDING__PARAMETERS);
		}
	...
	public String getText(Object object) {
		String label = null; // ((MKeyBinding)object).getId();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MApplicationPackage.Literals.KEY_BINDING__PARAMETERS,
				 MApplicationFactory.eINSTANCE.createParameter()));
