...
public class RemoteProject extends CVSModelElement implements IAdaptable {
	...
	public Object[] getChildren(Object o) {
		...
		return CVSUIPlugin.getPlugin().getRepositoryManager().getKnownVersionTags(resource.getRepository());
	}
	...
	public ImageDescriptor getImageDescriptor(Object object) {
		return CVSUIPlugin.getPlugin().getImageDescriptor(ICVSUIConstants.IMG_PROJECT_VERSIONS);
	}
