...
public class PersistenceAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.e4.ui.workbench.internal.persistence.IWorkbenchState <em>Workbench State</em>}'.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.e4.ui.workbench.internal.persistence.IPartMemento <em>Part Memento</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns
	 * null so that we can easily ignore cases; it's useful to ignore a case when
	 * inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * @return the new adapter.
