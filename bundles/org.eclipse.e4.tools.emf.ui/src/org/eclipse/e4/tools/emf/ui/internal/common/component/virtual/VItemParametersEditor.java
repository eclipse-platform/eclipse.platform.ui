...
public class VItemParametersEditor extends AbstractComponentEditor {
	...
	public VItemParametersEditor(EditingDomain editingDomain, ModelEditor editor, IResourcePool resourcePool) {
	...
	private Composite createForm(Composite parent, EMFDataBindingContext context, WritableValue master) {
...

		{
			...
			l.setText(Messages.VItemParametersEditor_Parameters);
