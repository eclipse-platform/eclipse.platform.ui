...
/**
 * <p>
 * An abstract implementation of a key formatter that provides a lot of common key formatting
 * functionality. It is recommended that implementations of <code>IKeyFormatter</code> subclass from
 * here, rather than implementing <code>IKeyFormatter</code> directly.
 * </p>
 * 
 * @since 3.1
 */
public abstract class AbstractKeyFormatter implements IKeyFormatter {
	...
	/**
	 * The key for the delimiter between key strokes. This is used in the internationalization
	 * bundles.
	 */
	protected static final String KEY_STROKE_DELIMITER_KEY = "KEY_STROKE_DELIMITER"; //$NON-NLS-1$

	/**
	 * An empty integer array that can be used in <code>sortModifierKeys(int)</code>.
	 */
	protected static final int[] NO_MODIFIER_KEYS = new int[0];

	/**
	 * The bundle in which to look up the internationalized text for all of the individual keys in
	 * the system. This is the platform-agnostic version of the internationalized strings. Some
	 * platforms (namely Carbon) provide special Unicode characters and glyphs for some keys.
	 */
	private static final ResourceBundle RESOURCE_BUNDLE = ResourceBundle
			.getBundle(AbstractKeyFormatter.class.getName());

	/**
	 * The keys in the resource bundle. This is used to avoid missing resource exceptions when they
	 * aren't necessary.
	 */
	 ...
	 * 
	 * @see
	 * org.eclipse.jface.bindings.keysKeyFormatter#format(org.eclipse.jface.bindings.keys.KeySequence
	 * )
	 */
	 ...
	 * 
	 * @see
	 * org.eclipse.jface.bindings.keys.KeyFormatter#format(org.eclipse.jface.bindings.keys.KeySequence
	 * )
	 */
	 ...
	 * 
	 * @see
	 * org.eclipse.jface.bindings.keys.KeyFormatter#formatKeyStroke(org.eclipse.jface.bindings.keys
	 * .KeyStroke)
	 */
	...
	/**
	 * An accessor for the delimiter you wish to use between keys. This is used by the default
	 * format implementations to determine the key delimiter.
	 * 
	...
	/**
	 * An accessor for the delimiter you wish to use between key strokes. This used by the default
	 * format implementations to determine the key stroke delimiter.
	 * 
	...
	/**
	 * Separates the modifier keys from each other, and then places them in an array in some sorted
	 * order. The sort order is dependent on the type of formatter.
	 * 
	 * @param modifierKeys
	 *            The modifier keys from the key stroke.
	 * @return An array of modifier key values -- separated and sorted in some order. Any values in
	 *         this array that are <code>KeyStroke.NO_KEY</code> should be ignored.
	 */
