...
/**
 * <p>
 * A key formatter providing the Emacs-style accelerators using single letters to represent the
 * modifier keys.
 * </p>
 * 
 * @since 3.1
...
public final class EmacsKeyFormatter extends AbstractKeyFormatter {
	...
	/**
	 * Formats an individual key into a human readable format. This converts the key into a format
	 * similar to Xemacs.
	 * 
	 * @param key
