...
/**
 * <p>
 * Formats the key sequences and key strokes into the native human-readable format. This is
 * typically what you would see on the menus for the given platform and locale.
 * </p>
 * 
 * @since 3.1
 */
public final class NativeKeyFormatter extends AbstractKeyFormatter {
	...
	/**
	 * The key into the internationalization resource bundle for the delimiter to use between keys
	 * (on the Carbon platform).
	 */
	...
	/**
	 * The resource bundle used by <code>format()</code> to translate formal string representations
	 * by locale.
	 */
	private final static ResourceBundle RESOURCE_BUNDLE;

	/**
	 * The key into the internationalization resource bundle for the delimiter to use between key
	 * strokes (on the Win32 platform).
	 */
