...
public class CSSPropertyTabAreaKeylineColorHandler extends AbstractCSSPropertySWTHandler {

	public static final ICSSPropertyHandler INSTANCE = new CSSPropertyTabAreaKeylineColorHandler();
	...
	public void applyCSSProperty(Control control, String property,
		...
		if (value.getCssValueType() == CSSValue.CSS_PRIMITIVE_VALUE) {
			...
			if (control instanceof ETabFolder) {
				...
				((ETabFolder) control).setTabAreaKeylineColor(newColor);
			}
		}
	}
