...
public class CSSPropertyBodyKeylineColorHandler extends AbstractCSSPropertySWTHandler {

	public static final ICSSPropertyHandler INSTANCE = new CSSPropertyBodyKeylineColorHandler();
	...
	public void applyCSSProperty(Control control, String property,
		...
		if (value.getCssValueType() == CSSValue.CSS_PRIMITIVE_VALUE) {
			...
			if (control instanceof ETabFolder) {
				...
				((ETabFolder) control).setBodyKeylineColor(newColor);
			}
		}
	}
