...
public class HistoryTextWrapper extends Composite {
	...
	private AccessibleToolBar tools;
	...
	private void createHistoryMenuDropdown() {
		...
		menu = new SearchHistoryMenu(getShell(), history, SelectionListener.widgetSelectedAdapter(f -> {
		...
		menu.getShell().addDisposeListener(new DisposeListener() {

			@Override
			public void widgetDisposed(DisposeEvent e) {
				getShell().getDisplay().timerExec(100, HistoryTextWrapper.this::enableDropDown);
			}
		});
	}
