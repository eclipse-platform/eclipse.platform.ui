...
public class TextEditTests {
	...
	public void testCovers1() throws Exception {
		...
		Assertions.assertFalse(insert.covers(delete));
	}
	...
	public void testCovers2() throws Exception {
		...
		Assertions.assertTrue(multi.covers(child));
	}
	...
	public void testUndefinedMultiEdit3() throws Exception {
		MultiTextEdit m2= new MultiTextEdit();
		Assertions.assertEquals(0, m2.getOffset());
		Assertions.assertEquals(0, m2.getLength());
		m2.addChild(new DeleteEdit(1,3));
		Assertions.assertEquals(1, m2.getOffset());
		Assertions.assertEquals(3, m2.getLength());
	}
	...
	public void testUndefinedMultiEdit4() throws Exception {
		...
		Assertions.assertEquals(1, m2.getOffset());
		Assertions.assertEquals(5, m2.getLength());
	}
	...
	public void testInsert1() throws Exception {
		...
		assertEquals(e1, 2, 2);
		assertEquals(e2, 4, 4);
		Assertions.assertEquals("Buffer content", "01yy345656789", fDocument.get());
	...
	public void testInsert2() throws Exception {
		...
		assertEquals(e1, 2, 2);
		assertEquals(e2, 4, 2);
		Assertions.assertEquals("Buffer content", "01yyxx23456789", fDocument.get());
	...
	public void testInsert3() throws Exception {
		...
		assertEquals(e2, 3, 2);
		assertEquals(e3, 5, 1);
		Assertions.assertEquals("Buffer content", "011xx2456789", fDocument.get());
	...
	public void testInsertReplace1() throws Exception {
		...
		assertEquals(e1, 4, 1);
		assertEquals(e2, 2, 2);
		Assertions.assertEquals("Buffer content", "01xxy3456789", fDocument.get());
	...
	public void testDelete1() throws Exception {
		...
		assertEquals(e1, 3, 0);
		Assertions.assertEquals("Buffer content", "012456789", fDocument.get());
	...
	public void testDelete2() throws Exception {
		...
		assertEquals(e2, 3, 0);
		assertEquals(e3, 3, 0);
		Assertions.assertEquals("Buffer content", "0126789", fDocument.get());
	...
	public void testDelete3() throws Exception {
		...
		assertEquals(e1, 3, 1);
		assertEquals(e2, 4, 0);
		Assertions.assertEquals("Buffer content", "012x456789", fDocument.get());
	...
	public void testDeleteWithChildren() throws Exception {
		...
		fRoot.addChild(e1);
		UndoEdit undo= fRoot.apply(fDocument);
		Assertions.assertEquals("Buffer content", "0189", fDocument.get());
	...
	public void testTreeUpdate1() throws Exception {
		...
		assertEquals(m2, 6, 2);
		UndoEdit undo= fRoot.apply(fDocument);
		Assertions.assertEquals("Buffer content", "01aa23bb45cc67dd89", fDocument.get());
		assertEquals(e1, 2, 2);
		assertEquals(e2, 6, 2);
	...
	public void testMove1() throws Exception {
		...
		fRoot.addChild(t1);
		UndoEdit undo= fRoot.apply(fDocument);
		Assertions.assertEquals("Buffer content", "0142356789", fDocument.get());
		assertEquals(s1, 2, 0);
		assertEquals(t1, 3, 2);
	...
	public void testMove2() throws Exception {
		...
		fRoot.addChild(t1);
		UndoEdit undo= fRoot.apply(fDocument);
		Assertions.assertEquals("Buffer content", "0156234789", fDocument.get());
		assertEquals(s1, 7, 0);
		assertEquals(t1, 2, 2);
	...
	public void testMove3() throws Exception {
		...
		fRoot.addChild(e2);
		UndoEdit undo= fRoot.apply(fDocument);
		Assertions.assertEquals("Buffer content", "01x5623789", fDocument.get());
		assertEquals(s1, 2, 0);
		assertEquals(t1, 5, 2);
		assertEquals(e2, 2, 1);
	...
	public void testMove4() throws Exception {
		...
		fRoot.addChild(e2);
		UndoEdit undo= fRoot.apply(fDocument);
		Assertions.assertEquals("Buffer content", "0178234x69", fDocument.get());
		assertEquals(s1, 9, 0);
		assertEquals(t1, 2, 2);
		assertEquals(e2, 7, 1);
	...
	public void testMove5() throws Exception {
		...
		assertEquals(t1, 2, 1);
		assertEquals(e2, 2, 1);
		Assertions.assertEquals("Buffer content", "01x3456789", fDocument.get());
	...
	public void testMove7() throws Exception {
		...
		fRoot.addChild(t1);
		UndoEdit undo= fRoot.apply(fDocument);
		Assertions.assertEquals("Buffer content", "01562x4789", fDocument.get());
		assertEquals(s1, 2, 0);
		assertEquals(t1, 4, 3);
		assertEquals(e2, 5, 1);
	...
	public void testMove8() throws Exception {
		...
		fRoot.addChild(t1);
		UndoEdit undo= fRoot.apply(fDocument);
		Assertions.assertEquals("Buffer content", "05x7123489", fDocument.get());
		assertEquals(s1, 8, 0);
		assertEquals(t1, 1, 3);
		assertEquals(e2, 2, 1);
	...
	public void testMove9() throws Exception {
		...
		assertEquals(s2, 2, 0);
		assertEquals(t2, 3, 1);
		Assertions.assertEquals("Buffer content", "0421356789", fDocument.get());
	...
	public void testMove10() throws Exception {
		...
		assertEquals(s2, 5, 0);
		assertEquals(t2, 1, 2);
		Assertions.assertEquals("Buffer content", "0561472389", fDocument.get());
	...
	public void testMoveWithTargetDelete() throws Exception {
		...
		fRoot.addChild(e2);
		UndoEdit undo= fRoot.apply(fDocument);
		Assertions.assertEquals("Buffer content", "01589", fDocument.get());
		assertEquals(s1, 2, 0);
	...
	public void testMoveDown() throws Exception {
		...
		UndoEdit undo= fRoot.apply(fDocument);
		Assertions.assertEquals("Buffer content", "014x562378", fDocument.get());
		assertEquals(s1, 2, 0);
		assertEquals(i1, 3, 1);
		assertEquals(t1, 6, 2);
		assertEquals(m1, 6, 2);
	...
	public void testMoveUp() throws Exception {
		...
		UndoEdit undo= fRoot.apply(fDocument);
		Assertions.assertEquals("Buffer content", "0178234x56", fDocument.get());
	...
	public void testMoveDownWithSourceDelete() throws Exception {
		...
		UndoEdit undo= fRoot.apply(fDocument);
		Assertions.assertEquals("Buffer content", "0145623789", fDocument.get());
		assertEquals(d1, 2, 0);
		assertTrue(s1.isDeleted());
		assertEquals(t1, 5, 2);
		assertEquals(m1, 5, 2);
	...
	public void testMoveUpWithInnerMark() throws Exception {
		...
		fRoot.addChild(s1);
		UndoEdit undo= fRoot.apply(fDocument);
		Assertions.assertEquals("Buffer content", "017823yy569", fDocument.get());
		assertEquals(s1, 10, 0);
		assertEquals(t1, 2, 2);
		assertEquals(m, 6, 2);
	...
	public void testMoveDownWithInnerMark() throws Exception {
		...
		fRoot.addChild(s1);
		UndoEdit undo= fRoot.apply(fDocument);
		Assertions.assertEquals("Buffer content", "01yy5623789", fDocument.get());
		assertEquals(s1, 2, 0);
		assertEquals(t1, 6, 2);
		assertEquals(m, 2, 2);
	...
	public void testMoveUpWithParentMark() throws Exception {
		...
		fRoot.addChild(m);
		UndoEdit undo= fRoot.apply(fDocument);
		Assertions.assertEquals("Buffer content", "0124536789", fDocument.get());
		assertEquals(m, 2, 6);
		assertEquals(t1, 3, 2);
		assertEquals(s1, 6, 0);
	...
	public void testNestedMoveSource() throws Exception {
		...
		Assertions.assertEquals("Buffer content", result, fDocument.get());
	...
	public void testSwap1() throws Exception {
		...
		Assertions.assertEquals("Buffer content", result, document.get());
	}
	...
	public void testMoveTree1() {
		...
		root.addChild(e2);
		root.moveTree(3);
		Assertions.assertEquals(3, root.getOffset());
		Assertions.assertEquals(4, root.getLength());
		Assertions.assertEquals(3, e1.getOffset());
		Assertions.assertEquals(1, e1.getLength());
		Assertions.assertEquals(5, e2.getOffset());
		Assertions.assertEquals(2, e2.getLength());
	}
	...
	public void testMoveTree2() {
		...
		root.addChild(e2);
		root.moveTree(-3);
		Assertions.assertEquals(0, root.getOffset());
		Assertions.assertEquals(4, root.getLength());
		Assertions.assertEquals(0, e1.getOffset());
		Assertions.assertEquals(1, e1.getLength());
		Assertions.assertEquals(2, e2.getOffset());
		Assertions.assertEquals(2, e2.getLength());
	}
	...
	public void testComparator() throws Exception {
		...
		Assertions.assertEquals(0, comparator.compare(edit1, edit1));
		Assertions.assertEquals(0, comparator.compare(edit1, edit2));
		Assertions.assertEquals(0, comparator.compare(edit2, edit1));
