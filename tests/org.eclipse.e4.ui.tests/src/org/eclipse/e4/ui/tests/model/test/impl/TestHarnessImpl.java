 ...
 * <em>Parameters</em>}</li>
 * <li>
 * {@link org.eclipse.e4.ui.tests.model.test.impl.TestHarnessImpl#getCategory
 * <em>Category</em>}</li>
 * <li>
 ...
 * <li>
 * {@link org.eclipse.e4.ui.tests.model.test.impl.TestHarnessImpl#getCurSharedRef
 * <em>Cur Shared Ref</em>}</li>
 * <li>
 * {@link org.eclipse.e4.ui.tests.model.test.impl.TestHarnessImpl#getVisibleWhen
 * <em>Visible When</em>}</li>
 * <li>
 * {@link org.eclipse.e4.ui.tests.model.test.impl.TestHarnessImpl#getAccessibilityPhrase
 * <em>Accessibility Phrase</em>}</li>
 * <li>
...
public class TestHarnessImpl extends ApplicationElementImpl implements
	...
	/**
	 * The cached value of the '{@link #getCurSharedRef()
	 * <em>Cur Shared Ref</em>}' reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getCurSharedRef()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getVisibleWhen() <em>Visible When</em>}'
	...
	/**
	 * The default value of the '{@link #getAccessibilityPhrase()
	 * <em>Accessibility Phrase</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getAccessibilityPhrase()
	 * <em>Accessibility Phrase</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getAccessibilityPhrase()
			...
			if (category != oldCategory) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							MTestPackage.TEST_HARNESS__CATEGORY, oldCategory,
							category));
			}
		}
		return category;
	...
	public void setCategory(MCategory newCategory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					MTestPackage.TEST_HARNESS__CATEGORY, oldCategory, category));
	}
	...
	public MPlaceholder getCurSharedRef() {
		if (curSharedRef != null && ((EObject) curSharedRef).eIsProxy()) {
			...
			if (curSharedRef != oldCurSharedRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							MTestPackage.TEST_HARNESS__CUR_SHARED_REF,
	...
	public void setCurSharedRef(MPlaceholder newCurSharedRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					MTestPackage.TEST_HARNESS__CUR_SHARED_REF, oldCurSharedRef,
					curSharedRef));
	}
	...
	public NotificationChain basicSetVisibleWhen(MExpression newVisibleWhen,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, MTestPackage.TEST_HARNESS__VISIBLE_WHEN,
					oldVisibleWhen, newVisibleWhen);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setVisibleWhen(MExpression newVisibleWhen) {
		if (newVisibleWhen != visibleWhen) {
			...
			if (visibleWhen != null)
				msgs = ((InternalEObject) visibleWhen).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- MTestPackage.TEST_HARNESS__VISIBLE_WHEN,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					MTestPackage.TEST_HARNESS__VISIBLE_WHEN, newVisibleWhen,
					newVisibleWhen));
	}
	...
	public void setAccessibilityPhrase(String newAccessibilityPhrase) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					MTestPackage.TEST_HARNESS__ACCESSIBILITY_PHRASE,
