...
private void checkChanges(IResourceDelta delta){
	...
	ExpectedChange expectedChange =
		(ExpectedChange)fExpectedChanges.remove(resource.getFullPath());
...
private void checkPaths(IResourceDelta delta){
	...
	ExpectedChange expectedChange =
		(ExpectedChange)fExpectedChanges.get(resource.getFullPath());
...
private void recordDuplicateChild(IPath path, int formerChildKind, int latterChildKind, int expectedKind){
	...
	switch(expectedKind){
		case IResourceDelta.ADDED: fMessage.append("Added"); break;
		case IResourceDelta.CHANGED: fMessage.append("Changed"); break;
		case IResourceDelta.REMOVED: fMessage.append("Removed"); break;
	}
