...
public class ElementTreeTest extends WatsonTest implements IPathConstants {
	...
	public void testChildCreation() {
		...
		/* add to empty tree */
		IPath key = Path.ROOT.append("only");
		assertTrue("not includes", !fEmptyTree.includes(key));
	...
	public void testComputeDeltaWith() {
		...
		TestUtil.assertHasPaths(newTree, new IPath[] {solution, project1, project2, project3, file2, file4, file5, folder1, folder2, folder3, folder4});
