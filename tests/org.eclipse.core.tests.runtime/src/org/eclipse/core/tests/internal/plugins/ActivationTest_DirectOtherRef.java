...
/**
 */
public class ActivationTest_DirectOtherRef extends EclipseWorkspaceTest {
...
public void extensionDirectReferenceToOtherClassTest() {
...
public static Test suite() {
	...
	suite.addTest(new ActivationTest_DirectOtherRef("extensionDirectReferenceToOtherClassTest"));
	return suite;
}
}
