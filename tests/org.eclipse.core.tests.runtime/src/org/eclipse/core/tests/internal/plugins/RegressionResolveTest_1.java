...
/**
 */
public class RegressionResolveTest_1 extends PluginResolveTest {
public RegressionResolveTest_1() {
	super(null);
}
public RegressionResolveTest_1(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/regression.resolve.1/");
	...
	assertEquals("2.2", pluginDescriptors[0].getVersionIdentifier(), new PluginVersionIdentifier("2.1.5"));
	...
	assertTrue("3.3", req.getMatch());
	assertTrue("3.4", !(req.getMatch()) == false);
	
}
public static Test suite() {
	TestSuite suite = new TestSuite();
	suite.addTest(new RegressionResolveTest_1("baseTest"));
	return suite;
}
}
