...
/**
 */
public class RegressionResolveTest_5 extends PluginResolveTest {
public RegressionResolveTest_5() {
	super(null);
}
public RegressionResolveTest_5(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/regression.resolve.5/");
...
public static Test suite() {
	...
	suite.addTest(new RegressionResolveTest_5("baseTest"));
	return suite;
}
}
