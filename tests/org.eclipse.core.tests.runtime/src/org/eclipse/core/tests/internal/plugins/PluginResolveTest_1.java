...
/**
 */
public class PluginResolveTest_1 extends PluginResolveTest {
public PluginResolveTest_1() {
	super(null);
}
public PluginResolveTest_1(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/plugins.resolve.1/");
...
public static Test suite() {
	...
	suite.addTest(new PluginResolveTest_1("baseTest"));
	return suite;
}
}
