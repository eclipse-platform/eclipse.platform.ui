...
/**
 */
public class PluginResolveTest_19 extends PluginResolveTest {
public PluginResolveTest_19() {
	super(null);
}
public PluginResolveTest_19(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/plugins.resolve.19/");
...
public static Test suite() {
	...
	suite.addTest(new PluginResolveTest_19("baseTest"));
	return suite;
}
}
