...
/**
 */
public class SoftPrereqTest_14 extends PluginResolveTest {
public SoftPrereqTest_14() {
	super(null);
}
public SoftPrereqTest_14(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/softPrereq.14/");
...
public static Test suite() {
	...
	suite.addTest(new SoftPrereqTest_14("baseTest"));
	return suite;
}
}
