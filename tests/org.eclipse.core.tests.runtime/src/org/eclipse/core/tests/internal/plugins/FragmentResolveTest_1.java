...
public class FragmentResolveTest_1 extends EclipseWorkspaceTest {
public FragmentResolveTest_1() {
	super(null);
}
public FragmentResolveTest_1(String name) {
	super(name);
}
...
public void test1() {
	...
	try {
		...
		String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/fragment.resolve.1/plugin1.xml");
...
public void test6() {
	...
	try {
		PluginDescriptor tempPlugin = (PluginDescriptor)Platform.getPluginRegistry().getPluginDescriptor("org.eclipse.core.tests.runtime");
		String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/fragment.resolve.1/plugin2.xml");
		pluginURLs[0] = new URL (pluginPath);
...
public static Test suite() {
	...
	suite.addTest(new FragmentResolveTest_1("test1"));
	suite.addTest(new FragmentResolveTest_1("test2"));
	suite.addTest(new FragmentResolveTest_1("test3"));
	suite.addTest(new FragmentResolveTest_1("test4"));
	suite.addTest(new FragmentResolveTest_1("test5"));
	suite.addTest(new FragmentResolveTest_1("test6"));
	suite.addTest(new FragmentResolveTest_1("test7"));
	return suite;
}
}
