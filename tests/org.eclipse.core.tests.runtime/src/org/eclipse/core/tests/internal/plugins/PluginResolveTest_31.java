...
/**
 */
public class PluginResolveTest_31 extends PluginResolveTest {
public PluginResolveTest_31() {
	super(null);
}
public PluginResolveTest_31(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/plugins.resolve.31/");
...
public static Test suite() {
	...
	suite.addTest(new PluginResolveTest_31("baseTest"));
	return suite;
}
}
