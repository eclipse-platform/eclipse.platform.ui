...
/**
 */
public class PluginResolveTest_32 extends PluginResolveTest {
public PluginResolveTest_32() {
	super(null);
}
public PluginResolveTest_32(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/plugins.resolve.32/");
...
public static Test suite() {
	...
	suite.addTest(new PluginResolveTest_32("baseTest"));
	return suite;
}
}
