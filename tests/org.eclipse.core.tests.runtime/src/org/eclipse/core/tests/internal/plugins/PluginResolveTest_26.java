...
/**
 */
public class PluginResolveTest_26 extends PluginResolveTest {
public PluginResolveTest_26() {
	super(null);
}
public PluginResolveTest_26(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/plugins.resolve.26/");
...
public static Test suite() {
	...
	suite.addTest(new PluginResolveTest_26("baseTest"));
	return suite;
}
}
