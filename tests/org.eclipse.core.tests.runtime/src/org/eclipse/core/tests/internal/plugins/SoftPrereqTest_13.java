...
/**
 */
public class SoftPrereqTest_13 extends PluginResolveTest {
public SoftPrereqTest_13() {
	super(null);
}
public SoftPrereqTest_13(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/softPrereq.13/");
...
public static Test suite() {
	...
	suite.addTest(new SoftPrereqTest_13("baseTest"));
	return suite;
}
}
