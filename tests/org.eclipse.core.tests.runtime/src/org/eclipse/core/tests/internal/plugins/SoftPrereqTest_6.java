...
/**
 */
public class SoftPrereqTest_6 extends PluginResolveTest {
public SoftPrereqTest_6() {
	super(null);
}
public SoftPrereqTest_6(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/softPrereq.6/");
...
public static Test suite() {
	...
	suite.addTest(new SoftPrereqTest_6("baseTest"));
	return suite;
}
}
