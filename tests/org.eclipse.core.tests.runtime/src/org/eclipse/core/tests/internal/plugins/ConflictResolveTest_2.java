...
/**
 */
public class ConflictResolveTest_2 extends PluginResolveTest {
public ConflictResolveTest_2() {
	super(null);
}
public ConflictResolveTest_2(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/conflictResolve.2/");
...
public static Test suite() {
	...
	suite.addTest(new ConflictResolveTest_2("baseTest"));
	return suite;
}
}
