...
/**
 */
public class PluginResolveTest_30 extends PluginResolveTest {
public PluginResolveTest_30() {
	super(null);
}
public PluginResolveTest_30(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/plugins.resolve.30/");
...
public static Test suite() {
	...
	suite.addTest(new PluginResolveTest_30("baseTest"));
	return suite;
}
}
