...
/**
 */
public class SoftPrereqTest_11 extends PluginResolveTest {
public SoftPrereqTest_11() {
	super(null);
}
public SoftPrereqTest_11(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/softPrereq.11/");
...
public static Test suite() {
	...
	suite.addTest(new SoftPrereqTest_11("baseTest"));
	return suite;
}
}
