...
/**
 */
public class SoftPrereqTest_12 extends PluginResolveTest {
public SoftPrereqTest_12() {
	super(null);
}
public SoftPrereqTest_12(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/softPrereq.12/");
...
public static Test suite() {
	...
	suite.addTest(new SoftPrereqTest_12("baseTest"));
	return suite;
}
}
