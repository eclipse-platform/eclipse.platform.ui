...
/**
 */
public class SoftPrereqTest_7 extends PluginResolveTest {
public SoftPrereqTest_7() {
	super(null);
}
public SoftPrereqTest_7(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/softPrereq.7/");
...
public static Test suite() {
	...
	suite.addTest(new SoftPrereqTest_7("baseTest"));
	return suite;
}
}
