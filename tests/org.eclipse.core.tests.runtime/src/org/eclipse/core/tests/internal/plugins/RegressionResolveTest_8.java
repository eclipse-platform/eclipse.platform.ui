...
/**
 */
public class RegressionResolveTest_8 extends PluginResolveTest {
public RegressionResolveTest_8() {
	super(null);
}
public RegressionResolveTest_8(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/regression.resolve.8/");
...
public static Test suite() {
	...
	suite.addTest(new RegressionResolveTest_8("baseTest"));
	return suite;
}
}
