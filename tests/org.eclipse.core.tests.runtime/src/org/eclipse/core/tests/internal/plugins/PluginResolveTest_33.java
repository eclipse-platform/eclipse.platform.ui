...
/**
 */
public class PluginResolveTest_33 extends PluginResolveTest {
public PluginResolveTest_33() {
	super(null);
}
public PluginResolveTest_33(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/plugins.resolve.33/");
...
public static Test suite() {
	...
	suite.addTest(new PluginResolveTest_33("baseTest"));
	return suite;
}
}
