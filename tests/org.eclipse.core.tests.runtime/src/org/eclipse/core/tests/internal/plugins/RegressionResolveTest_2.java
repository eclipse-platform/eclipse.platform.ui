...
/**
 */
public class RegressionResolveTest_2 extends PluginResolveTest {
public RegressionResolveTest_2() {
	super(null);
}
public RegressionResolveTest_2(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/regression.resolve.2/");
...
public static Test suite() {
	...
	suite.addTest(new RegressionResolveTest_2("baseTest"));
	return suite;
}
}
