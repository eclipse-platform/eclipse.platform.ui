...
/**
 */
public class PluginResolveTest_24 extends PluginResolveTest {
public PluginResolveTest_24() {
	super(null);
}
public PluginResolveTest_24(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/plugins.resolve.24/");
...
public static Test suite() {
	...
	suite.addTest(new PluginResolveTest_24("baseTest"));
	return suite;
}
}
