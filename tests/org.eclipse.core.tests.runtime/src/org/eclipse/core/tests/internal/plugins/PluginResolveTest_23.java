...
/**
 */
public class PluginResolveTest_23 extends PluginResolveTest {
public PluginResolveTest_23() {
	super(null);
}
public PluginResolveTest_23(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/plugins.resolve.23/");
	...
	assertEquals("2.2", pluginDescriptors[0].getVersionIdentifier(), new PluginVersionIdentifier("2.3.0"));
	
	
}
public static Test suite() {
	TestSuite suite = new TestSuite();
	suite.addTest(new PluginResolveTest_23("baseTest"));
	return suite;
}
}
