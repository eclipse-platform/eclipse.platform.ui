...
/**
 */
public class PluginResolveTest_29 extends PluginResolveTest {
public PluginResolveTest_29() {
	super(null);
}
public PluginResolveTest_29(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/plugins.resolve.29/");
...
public static Test suite() {
	...
	suite.addTest(new PluginResolveTest_29("baseTest"));
	return suite;
}
}
