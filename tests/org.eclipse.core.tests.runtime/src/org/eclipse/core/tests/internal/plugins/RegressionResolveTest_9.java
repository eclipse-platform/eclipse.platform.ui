...
/**
 */
public class RegressionResolveTest_9 extends PluginResolveTest {
public RegressionResolveTest_9() {
	super(null);
}
public RegressionResolveTest_9(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/regression.resolve.9/");
...
public static Test suite() {
	...
	suite.addTest(new RegressionResolveTest_9("baseTest"));
	return suite;
}
}
