...
/**
 */
public class ConflictResolveTest_5 extends PluginResolveTest {
public ConflictResolveTest_5() {
	super(null);
}
public ConflictResolveTest_5(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/conflictResolve.5/");
...
public static Test suite() {
	...
	suite.addTest(new ConflictResolveTest_5("baseTest"));
	return suite;
}
}
