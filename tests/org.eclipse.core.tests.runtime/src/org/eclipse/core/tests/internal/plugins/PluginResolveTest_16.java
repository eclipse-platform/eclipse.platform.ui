...
/**
 */
public class PluginResolveTest_16 extends PluginResolveTest {
public PluginResolveTest_16() {
	super(null);
}
public PluginResolveTest_16(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/plugins.resolve.16/");
	...
	assertEquals("2.2", pluginDescriptors[0].getVersionIdentifier(), new PluginVersionIdentifier("2.0.1"));
	
	
}
public static Test suite() {
	TestSuite suite = new TestSuite();
	suite.addTest(new PluginResolveTest_16("baseTest"));
	return suite;
}
}
