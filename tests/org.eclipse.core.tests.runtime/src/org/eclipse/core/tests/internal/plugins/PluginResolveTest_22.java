...
/**
 */
public class PluginResolveTest_22 extends PluginResolveTest {
public PluginResolveTest_22() {
	super(null);
}
public PluginResolveTest_22(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/plugins.resolve.22/");
...
public static Test suite() {
	...
	suite.addTest(new PluginResolveTest_22("baseTest"));
	return suite;
}
}
