...
/**
 */
public class RegressionResolveTest_6 extends PluginResolveTest {
public RegressionResolveTest_6() {
	super(null);
}
public RegressionResolveTest_6(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/regression.resolve.6/");
	...
	assertEquals("2.2", pluginDescriptors[0].getVersionIdentifier(), new PluginVersionIdentifier("2.1.3"));
...
public static Test suite() {
	...
	suite.addTest(new RegressionResolveTest_6("baseTest"));
	return suite;
}
}
