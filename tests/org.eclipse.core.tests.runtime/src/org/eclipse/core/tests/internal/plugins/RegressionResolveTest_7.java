...
/**
 */
public class RegressionResolveTest_7 extends PluginResolveTest {
public RegressionResolveTest_7() {
	super(null);
}
public RegressionResolveTest_7(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/regression.resolve.7/");
...
public static Test suite() {
	...
	suite.addTest(new RegressionResolveTest_7("baseTest"));
	return suite;
}
}
