...
public RegressionResolveTest_3() {
	super(null);
}
public RegressionResolveTest_3(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/regression.resolve.3/");
...
public static Test suite() {
	...
	suite.addTest(new RegressionResolveTest_3("baseTest"));
	return suite;
}
}
