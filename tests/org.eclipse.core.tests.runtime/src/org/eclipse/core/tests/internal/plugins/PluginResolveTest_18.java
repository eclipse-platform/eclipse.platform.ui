...
/**
 */
public class PluginResolveTest_18 extends PluginResolveTest {
public PluginResolveTest_18() {
	super(null);
}
public PluginResolveTest_18(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/plugins.resolve.18/");
	...
	assertEquals("2.2", pluginDescriptors[0].getVersionIdentifier(), new PluginVersionIdentifier("2.0.2"));
	
	
}
public static Test suite() {
	TestSuite suite = new TestSuite();
	suite.addTest(new PluginResolveTest_18("baseTest"));
	return suite;
}
}
