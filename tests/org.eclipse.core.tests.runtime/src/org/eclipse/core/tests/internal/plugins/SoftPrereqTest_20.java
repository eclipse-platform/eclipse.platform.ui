...
/**
 */
public class SoftPrereqTest_20 extends PluginResolveTest {
public SoftPrereqTest_20() {
	super(null);
}
public SoftPrereqTest_20(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/softPrereq.20/");
	...
	assertEquals("0.0", pluginDescriptors.length, 3);
	
	// Should be identical to softPrereq.6 as the only difference is the order of the 
	// requires.
	...
	assertEquals("4.2", pluginDescriptors[0].getVersionIdentifier(), new PluginVersionIdentifier("1.0.1"));
...
public static Test suite() {
	...
	suite.addTest(new SoftPrereqTest_20("baseTest"));
	return suite;
}
}
