...
/**
 */
public class ConflictResolveTest_6 extends PluginResolveTest {
public ConflictResolveTest_6() {
	super(null);
}
public ConflictResolveTest_6(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/conflictResolve.6/");
...
public static Test suite() {
	...
	suite.addTest(new ConflictResolveTest_6("baseTest"));
	return suite;
}
}
