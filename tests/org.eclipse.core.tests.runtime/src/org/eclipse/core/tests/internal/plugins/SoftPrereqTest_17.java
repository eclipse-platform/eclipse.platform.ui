...
/**
 */
public class SoftPrereqTest_17 extends PluginResolveTest {
public SoftPrereqTest_17() {
	super(null);
}
public SoftPrereqTest_17(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/softPrereq.17/");
	...
	// Should be identical to softPrereq.3 as the only difference is the order of the 
	// requires.
...
public static Test suite() {
	...
	suite.addTest(new SoftPrereqTest_17("baseTest"));
	return suite;
}
}
