...
/**
 */
public class RegressionResolveTest_10 extends PluginResolveTest {
public RegressionResolveTest_10() {
	super(null);
}
public RegressionResolveTest_10(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/regression.resolve.10/");
	...
	assertEquals("2.2", pluginDescriptors[0].getVersionIdentifier(), new PluginVersionIdentifier("3.1.0"));
...
public static Test suite() {
	...
	suite.addTest(new RegressionResolveTest_10("baseTest"));
	return suite;
}
}
