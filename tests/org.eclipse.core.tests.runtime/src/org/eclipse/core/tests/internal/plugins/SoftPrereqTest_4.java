...
/**
 */
public class SoftPrereqTest_4 extends PluginResolveTest {
public SoftPrereqTest_4() {
	super(null);
}
public SoftPrereqTest_4(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/softPrereq.4/");
...
public static Test suite() {
	...
	suite.addTest(new SoftPrereqTest_4("baseTest"));
	return suite;
}
}
