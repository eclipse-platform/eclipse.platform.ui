...
/**
 */
public class PluginResolveTest_28 extends PluginResolveTest {
public PluginResolveTest_28() {
	super(null);
}
public PluginResolveTest_28(String name) {
	super(name);
}
public void baseTest() {
	...
	String pluginPath = tempPlugin.getLocation().concat("Plugin_Testing/plugins.resolve.28/");
	...
	assertEquals("1.2", new PluginVersionIdentifier("2.2.0"), plugins[0].getVersionIdentifier());
}
public static Test suite() {
	TestSuite suite = new TestSuite();
	suite.addTest(new PluginResolveTest_28("baseTest"));
	return suite;
}
}
