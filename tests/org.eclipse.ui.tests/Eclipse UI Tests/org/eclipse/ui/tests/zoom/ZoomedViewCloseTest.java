...
public class ZoomedViewCloseTest extends CloseTest {
     ...
     * <p>Expected result: The view unzooms but remains active. A new editor is selected as the
     *    active editor.</p>
     * <p>Note: Whenever the active editor changes, the workbench should unzoom if necessary
     *    to make the active editor visible -- even if the active editor isn't the active part.</p>
     */
