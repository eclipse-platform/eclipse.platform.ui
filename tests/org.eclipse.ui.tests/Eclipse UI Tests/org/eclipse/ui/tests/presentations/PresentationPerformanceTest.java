...
public class PresentationPerformanceTest extends BasicPerformanceTest {
    ...
    protected void doSetUp() throws Exception {
        ...
        img = TestPlugin.getDefault().getImageDescriptor("anything.gif").createImage();
        img2 = TestPlugin.getDefault().getImageDescriptor("view.gif").createImage();
    }
    ...
    protected PresentationTestbed createPresentation(AbstractPresentationFactory factory, int type, int numParts) {
