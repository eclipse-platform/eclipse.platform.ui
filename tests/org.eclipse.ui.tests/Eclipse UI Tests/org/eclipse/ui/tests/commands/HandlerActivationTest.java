...
public class HandlerActivationTest {
	...
	static class OutlineOnlyHandler extends AbstractHandler {
		...
		public void setEnabled(Object evaluationContext) {
			IWorkbenchPart part = (IWorkbenchPart) HandlerUtil.getVariable(evaluationContext,
	...
	private static final String[][] CREATE_CONTEXTS = {
			...
			{ C2_ID, "Active Action Sets", null, IContextService.CONTEXT_ID_WINDOW },
			{ C3_ID, "Active Shell", null, IContextService.CONTEXT_ID_WINDOW },
			{ C4_ID, "Active Workbench Window Shell", null, IContextService.CONTEXT_ID_WINDOW },
			{ (C_PREFIX + ISources.ACTIVE_MENU_NAME), "Active Workbench Window Shell", null,
	...
	public void testExceptionThrowingHandler() {
		assertThrows("An exception should be thrown for this handler", ExecutionException.class,
	...
	public void testForBreak123() throws Exception {
		...
		createHandlerActivation(C2_ID, H2,
				new String[] { ISources.ACTIVE_CONTEXT_NAME, ISources.ACTIVE_ACTION_SETS_NAME });
