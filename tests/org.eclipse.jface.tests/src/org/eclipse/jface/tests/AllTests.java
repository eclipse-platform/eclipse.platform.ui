...
@RunWith(Suite.class)
@SuiteClasses({ AllActionTests.class, AllImagesTests.class, AllLayoutTests.class, AllPrefsTests.class,
		AllResourcesTests.class, AllViewersTests.class, AllWidgetTests.class, DecoratingLabelProviderTests.class,
